...
no-bigger derivation of \seq{\Delta^*,\Gamma^*}{x_1 \otimes \ldots
  \otimes x_n}{\Uempty{\dsd{f}}{A}}.  Applying Lemma~\ref{lem:Uinv-subderivation},
we get a no-bigger derivation of 
\seq{\Delta^*,\Gamma^*}{\dsd{f}(x_1 \otimes \ldots \otimes x_n)}{A}.  
Again using Lemma~\ref{lem:respectspr}, we get 
\seq{\Delta^*,\Gamma^*}{\dsd{f}(x_1) \otimes \ldots \otimes \dsd{f}(x_n)}{A}.  
