...
\Cuta{\E}{\ULd{x}{}{s}{\vec{\D/y}}{z.\D_2}}{x_0} & := & \ULd{x}{}{1_\beta[s/x_0]}{\vec{\D/y}}{z.\Cuta{\E}{\D_2}{x}} & (\E = \FL^{x_0},\UL^{x_0}) \\
\\
...
derivation.  The next three rules correspond to instances of
functoriality of the respect-for-transformations in \UL\/ and \FR\/.
The final block of rules are are manifestations of associativity of cut
(and functoriality).  If the continuation of a \UL is given by weakening
or contraction, then we can instead eliminate or duplicate the \UL.  \FR\/
and \UL\/ can be permuted, and a \UL\/ in the ``arguments'' of another \UL\/
can be moved out first.  Finally, two successive \UL's with independent
neutral terms can be permuted.  

\begin{conjecture}{Soundness of Permutative Equality}
\begin{enumerate}
...
\begin{conjecture}{Completeness of Permutative Equality.}\\
