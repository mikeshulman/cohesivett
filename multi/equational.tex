...
\Cut{\FLd{x}{\Delta.\E}}{\D}{x_0} & \redto & \FLd{x}{\Delta.\Cut{\E}{\Linv{\D}{x}}{x_0}} & (x \neq x_0) \\%% {(x \neq x_0, \text{($\D$ not a left rule)})}\\
\Cut{\ULd{x}{}{s}{\vec{\E_i}/x_i}{z.\E'}}{\D}{x_0} & \redto & {\ULd{x}{}{s[1_{\alpha_0}/x_0]}{\vec{(\Cut{\E_i}{\D}{x_0})/x_i}}{z.\Cut{\E'}{\D}{x_0}}} & (x \neq x_0)\\%%,\text{$\D$ not a left rule}) \
\\
\Cut{\E}{\FLd{x}{\Delta.\D}}{x_0} & \redto & \FLd{x}{\Delta.\Cut{\Linv{\E}{x}}{\D}{x_0}} & \E = \FL^{x_0},\UL^{x_0}\\%%\text{($\E$ a left rule)}
\Cut{\E}{\ULd{x}{}{s}{\vec{\D/y}}{z.\D_2}}{x_0} & \redto & \ULd{x}{}{1_\beta[s/x_0]}{\vec{\D/y}}{z.\Cut{\E}{\D_2}{x}} & \E = \FL^{x_0},\UL^{x_0} \\%%\text{($\E$ a left rule)}\\
\end{array}
\]
