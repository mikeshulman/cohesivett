...
contexts and the structural properties they obey.  
%% The makes use of
...
%% that constrains how the context can be used.
...
%% complete for this.  
We show how the framework can be used both to encode existing existing
...
monads) are available in an extended version of this paper, from
\url{http://dlicata.web.wesleyan.edu/pubs.html}.
