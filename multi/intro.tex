...
frameworks~\citep{cervesatopfenning02llf,watkins+03clf-tr} is that
logics are ``embedded'' in our calculus (giving a type translation such
that provability in the object logic corresponds to provability in
ours), rather than ``encoding'' the structure of
