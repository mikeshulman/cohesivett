...
\begin{enumerate}
\item If \seq{\Gamma}{\alpha}{A} and $\alpha \deq \alpha'$ then
\seq{\Gamma}{\alpha'}{A}, and the resulting derivation has the same size
as the given one.
...
\begin{lemma}[Left-invertibility of \Fsymb]
