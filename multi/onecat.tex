...
\[
\infer[\FL]{\seq{\Gamma}{x}{\F{\alpha}{\Delta}}}
      {x:\F{\alpha}{\Delta} \in \Gamma &
        \infer[\FR]{\seq{\Gamma,\Delta}{\alpha}{\F{\alpha}{\Delta}}}
...
\item (2 additional pairs, plus 3 overlapping with above) $\FL$ and
  ...
  building the contraction discussed above into $\FL$.
...
\item (3 pairs) Right/identity and $\FL$.  
...
\begin{proof}
The ``direct'' use of $\UL$ with identities in both premises gives
a derivation
\[
