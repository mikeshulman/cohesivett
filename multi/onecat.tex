...
\begin{theorem}[Weakening over weakening]
If \seq{\Gamma,\Gamma'}{\alpha}{C} then
\seq{\Gamma,\tptm{z}{A},\Gamma'}{\alpha}{C}.
\end{theorem}
\begin{proof}
...
\begin{proof}
Induction ordering: Part 1 and 2: cut formula, then simultaneous on \D\/
and \E\/.  Part 3: 
...
\[
\deduce{\seq{\Gamma,\Gamma'}{\alpha_0}{A_0}}{\D} \qquad
\infer{\seq{\Gamma,x:A_0,\Gamma'}{\beta}{\U{x.\alpha}{\Delta}{A}}}
      {\deduce{\seq{\Gamma,x:A_0,\Gamma',\Delta}{\subst{\alpha}{\beta}{x}}{A}}{\E}}
\]
