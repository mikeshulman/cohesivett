...
A sequent in this type theory will be written $\Gamma \mid \Delta \vdash C$, with the constant types $\Gamma$ separated from the non-constant types $\Delta$. Similar to the case of the S4 $\Box$ modality, we represent a sequent 
\[
