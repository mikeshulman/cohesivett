...
natural transformations.  Since the objects of \Adj\/ are categories,
...
equations to verify to check inverses, naturality, conjugation, and
...
conditions, and inverse laws are all true for \ap{}{}; the proof is
about 150 lines of Agda.  
\end{proof}
...
pseudofunctor $S : \M \to \Adj$.  On the semantic side, we write
\begin{itemize}
\item $\C_p$ for $S(p)$
