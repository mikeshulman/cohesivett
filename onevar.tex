...
for these models.  On the semantic side, we write
\begin{itemize}
\item $\C_p$ for $S(p)$
\item $\semFo{\alpha}{} \la \semUo{\alpha}$ for $S(\alpha)$, and
  \semltor{-} and \semrtol{-} for two maps of hom-sets of the adjunction
\item $\semF{e}{} : \arrow{}{\F \beta A}{\F \alpha A}$
and $\semU{e}{} : \arrow{}{\U \alpha A}{\U \beta A}$
 when {e : \tc{\alpha}{\beta}}
...
composite 
\[
(\semFo{e} : \arrow{}{\semF \alpha {\sem P}}{\semF{1}{\sem P}}); (\semFone : \arrow{}{\semF 1 {\sem P}}{\sem P})
\]
...
\begin{lemma}
For all derivations $D$, $\sem{\tr{e}{D}} = \semFo{e};{\sem{D}}$.  
\end{lemma}
\begin{proof}
