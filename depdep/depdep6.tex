...
\end{align*}
With corresponding term equalities: \mvrnote{TODO: F and U}
\begin{align*}
...
Such pairs $\{ \Theta, s \}$ are considered up to the following relation:
\begin{align*}
...
\item[\textsc{type-sub}] Choose a representative of the translation of $\Theta$, say $\{ \upstairs{\Theta}, s_\Theta \}$ where: \mvrnote{This notation is a little confusing, I don't mean to say that $\upstairs{\Theta}$ and $s_\Theta$ are necessarily in the image of the translation.}
\begin{align*}
...
\item[\textsc{term-sub}] Again choose a representative of the translation of the substitution, $\{ \upstairs{\Theta}, s_\Theta \}$. We have:
\begin{align*}
...
This again respects the relation on pairs $\{ \upstairs{\Theta}, s_\Theta \}$:
\begin{align*}
...
\begin{align*}
\{ (\rewrite{t}{\Theta};\kappa), s_\Theta; (s_\kappa[\downstairs{\Theta}]) \} \sim \{ (\Theta;\kappa), (s_\Theta ; \ap{\asdep{\Delta}}{t} ; s_\kappa[\downstairs{\Theta}']) \}
\end{align*}
We have:
\begin{align*}
\{ (\Theta;\kappa), (s_\Theta ; \ap{\asdep{\Delta}}{t} ; s_\kappa[\downstairs{\Theta}']) \}
&\equiv \{ (\Theta;\kappa), (s_\Theta ; s_\kappa[\downstairs{\Theta}] ; \ap{\asdep{\Lambda}[\kappa]}{t}) \} \\
&\equiv \{ (\Theta;\kappa), (s_\Theta ; s_\kappa[\downstairs{\Theta}] ; \ap{\asdep{\Lambda}}{\ap{\kappa}{t}}) \} \\
&\sim \{ \rewrite{\ap{\kappa}{t}}{\Theta;\kappa}, (s_\Theta ; s_\kappa[\downstairs{\Theta}]) \} \\
&\equiv \{ (\rewrite{t}{\Theta};\kappa), (s_\Theta; s_\kappa[\downstairs{\Theta}]) \} \\
\end{align*}
as required. Second, we check it is well defined with respect to the choice of representative of $\kappa$, i.e.:
\begin{align*}
\{ (\Theta;\rewrite{t}{\kappa}), s_\Theta; (s_\kappa[\downstairs{\Theta}]) \} \sim \{ (\Theta;\kappa), (s_\Theta ; (s_\kappa;\ap{\asdep{\Lambda}}{t})[\downstairs{\Theta}']) \}
\end{align*}
Checking this:
\begin{align*}
\{ (\Theta;\kappa), (s_\Theta ; (s_\kappa;\ap{\asdep{\Lambda}}{t})[\downstairs{\Theta}]) \}
&\equiv \{ (\Theta;\kappa), (s_\Theta ; s_\kappa[\downstairs{\Theta}];\ap{\asdep{\Lambda}}{t}[\downstairs{\Theta}]) \} \\
&\equiv \{ (\Theta;\kappa), (s_\Theta ; s_\kappa[\downstairs{\Theta}];\ap{\asdep{\Lambda}[\downstairs{\Theta}]}{t[\downstairs{\Theta}]}) \} \\
&\sim \{ \rewrite{t[\downstairs{\Theta}]}{\Theta;\kappa}, (s_\Theta ; s_\kappa[\downstairs{\Theta}]) \} \\
&\equiv \{ (\Theta;\rewrite{t}{\kappa}), (s_\Theta ; s_\kappa[\downstairs{\Theta}]) \}
\end{align*}
