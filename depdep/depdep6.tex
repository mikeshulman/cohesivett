...
&\text{(Above equation)} \\
&\equiv \ap{(\TrCirc{\ApEl{p}{\pi^\alpha_{\TrCirc{\ApEl{p}{s}}{1_\beta}}}}{z})}{\eta^{\ApEl{p}{\pi^\alpha_{\TrCirc{\ApEl{p}{s}}{1_\beta}}}}_{\TrCirc{\ApEl{p}{H(s)}}{1_\beta}}/z};\varepsilon^{\ApEl{p}{\pi^\alpha_{\TrCirc{\ApEl{p}{s}}{1_\beta}}}}_{\TrCirc{\ApEl{p}{\pi^\alpha_{\TrCirc{\ApEl{p}{s}}{1_\beta}}}}{\TrCirc{\ApEl{p}{H(s)}}{1_\beta}}} \\
...
& \text{(Fusion for $\bdot$)} \\
&\equiv \eta^\chi_{\alpha.x} ; (\pi^\alpha_x \bdot \eta^{\ApEl{p}{\pi^\alpha_x}}_{1_{\alpha.x}} ; \ApPlus{\ApEl{p}{\pi^\alpha_x}}{\ap{\ApEl{p}{\pi^\alpha_x}^\circ}{\var{x}} ; \varepsilon^{\ApEl{p}{\pi^\alpha_x}}_x}) \\
& \text{(Fusion for ap)} \\
&\equiv \eta^\chi_{\alpha.x} ; (\pi^\alpha_x \bdot \eta^{\ApEl{p}{\pi^\alpha_x}}_{1_{\alpha.x}} ; \ApPlus{\ApEl{p}{\pi^\alpha_x}}{\ap{\ApEl{p}{\pi^\alpha_x}^\circ}{\var{x}}} ; \ApPlus{\ApEl{p}{\pi^\alpha_x}}{\varepsilon^{\ApEl{p}{\pi^\alpha_x}}_x}) \\
& \text{(Naturality of $\eta$)} \\
&\equiv \eta^\chi_{\alpha.x} ; (\pi^\alpha_x \bdot \var{x} ; \eta^{\ApEl{p}{\pi^\alpha_x}}_{\ApPlus{\ApEl{p}{\pi^\alpha_x}}{x}} ; \ApPlus{\ApEl{p}{\pi^\alpha_x}}{\varepsilon^{\ApEl{p}{\pi^\alpha_x}}_x}) \\
...
\inferrule*[left=$\Sigma$-split]{\Gamma, A, B \qyields c : C[(\proj{\Gamma, A, B};\proj{\Gamma, A}), \mathsf{pair}_{A,B}]}{\Gamma, \Sigma_A B \qyields \mathsf{split}_{A, B}(c) : C}
...
Suppose $p$ supports stable $\Sigma$-types. In the framework, $\Sigma$-types are the $\mathsf{F}$-types for the mode term
\begin{align*}
\alpha : p, x : \El{p}{\alpha}, y : \El{p}{\alpha.x} \yields \Sigma_1(\alpha,x,y) :\equiv \TrCirc{\ApEl{p}{\pi^\alpha_x}}{y} : \El{p}{\alpha}
\end{align*}
%We will use the following 2-cells:
%\begin{align*}
%
%\end{align*}
