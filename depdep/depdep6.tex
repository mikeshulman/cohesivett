...
$\El{p}{\pi}^\circ$ is a morphism of bifibrations in the above sense.
...
\item $\mathcal{E}$ has no direct analogue in the syntax, but has
  ...
  \alpha$ and $\nu \vDash_{\El{p}{\beta}} t : \El{p}{s}^+ (\mu)$. (We
...
\begin{align*}
\ApEl{p}{\pi}^\circ(y) \equiv \ApEl{p}{\pi^\alpha_x}^\circ(\ApEl{p}{\pi^{\alpha.x}_y}^\circ(1_{\alpha.x.y})) \equiv \El{p}{\pi;\pi}^\circ(1_{\alpha.x.y}) \\
\ApEl{p}{\pi^\alpha_x}^+(y) \equiv \ApEl{p}{\pi^{\alpha.x}_{\ApEl{p}{\pi^\alpha_x}^+(y)}}^\circ(1_{\alpha.x.\El{p}{\pi}^+(y)})
\end{align*}
