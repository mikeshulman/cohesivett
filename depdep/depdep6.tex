...
usual $\eta$ principle for subsitutions.
...
\item The functor $1$ is given by $\chi^\circ$, and $\{-\}$ is given by $\chi^+$. These are automatically adjoint.
\end{itemize}
\end{remark}
...
\begin{definition}
  A comprehension object \emph{has $\Sigma$s} if
\[
...
\begin{definition}
  A comprehension object \emph{has $\Pi$s} if
\[
