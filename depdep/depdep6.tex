...
\mvrnote{Should we write $t[s/x]$ as shorthand for either side of the
  last equation?}

\drlnote{\ap t {s/x} would be more consistent, I think}
...
\begin{mathpar}
\inferrule{\gamma \yields t : \theta \vDash \theta' \and \gamma \yields s : (\mu[\theta] \vDash \TrPlus{\ap{p}{t}}{\mu'[\theta']})}
{ \gamma \yields (s, t) : (\theta, \mu) \vDash (\theta', \mu') } \\
%
