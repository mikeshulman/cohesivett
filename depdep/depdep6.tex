...
&\equiv \dots \\ 
&\equiv \U{c.\TrCirc{(\id_{\asdep{\Delta}.x} \bdot \varepsilon^{s_\Theta}_x)}{\TrCirc{(s_\Theta \bdot \eta^{s_\Theta}_{\TrPlus{s_\Theta}{x}})}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}}}}{x :\upstairs{A}[\upstairs{\Theta}]}{\upstairs{B}[\upstairs{\Theta}, x/x]} \\
&\equiv \U{c.\TrCirc{(s_\Theta \bdot \eta^{s_\Theta}_{\TrPlus{s_\Theta}{x}})}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}}}{x :\upstairs{A}[\upstairs{\Theta}]}{\St{(\id_{\asdep{\Delta}.x} \bdot \varepsilon^{s_\Theta}_x)}{\upstairs{B}[\upstairs{\Theta}, x/x]}} \\
&\equiv \U{c.\TrCirc{(s_\Theta \bdot \eta^{s_\Theta}_{\TrPlus{s_\Theta}{x}})}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}}}{x :\upstairs{A}[\upstairs{\Theta}]}{\upstairs{B}[\upstairs{\Theta}, \rewrite{\varepsilon^{s_\Theta}_x}{x}/x]} \\
&\equiv \U{c.\TrCirc{(s_\Theta \bdot \eta^{s_\Theta}_{\TrPlus{s_\Theta}{x}})}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}}}{x :\upstairs{A}[\upstairs{\Theta}]}{\upstairs{B}[\upstairs{\Theta}, \UnSt{s_\Theta}{x}/x][\StI{s_\Theta}{x}/x]} \\
&\equiv \U{c.\TrCirc{(s_\Theta \bdot \eta^{s_\Theta}_x)}{\TrPlus{\pi^{\asdep{\Gamma}}_x}{c}}}{x : \St{s_\Theta}{\upstairs{A}[\upstairs{\Theta}]}}{\upstairs{B}[\upstairs{\Theta}, \UnSt{s_\Theta}{x}/x]} \\
...
\end{align*}
In the middle we verify, using Beck-Chevalley, 
\begin{align*}
...
&\equiv \TrCirc{(s_{\Theta} . (\eta^{s_\Theta}_{\TrPlus{s_{\Theta}}{x}};\ap{{s_{\Theta}}^+}{\varepsilon^{s_\Theta}_x}))}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}} \\
&\equiv \TrCirc{((s_{\Theta} . \eta^{s_\Theta}_{\TrPlus{s_{\Theta}}{x}}) ; (\id_{} \bdot \varepsilon^{s_\Theta}_x))}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}} \\
&\equiv \TrCirc{(\id_{} \bdot \varepsilon^{s_\Theta}_x)}{\TrCirc{(s_{\Theta} . \eta^{s_\Theta}_{\TrPlus{s_{\Theta}}{x}})}{\TrPlus{\pi^{\asdep{\Gamma}}_{\TrPlus{s_\Theta}{x}}}{c}}} \\
\end{align*}
\end{enumerate}
