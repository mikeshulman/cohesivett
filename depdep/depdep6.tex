...
We write $\ap p {t/x}$ (or just \ap p {t}) for whiskering
$\id_p[t/x]$ (and similarly for other kinds of horizontal
composition).  We need congruence for $\Sigma$ to be a rule (because we
