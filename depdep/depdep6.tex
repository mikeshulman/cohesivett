...
composition).  Congruence for $\Sigma$ to be a rule (because we
...
\end{mathpar}
\drlnote{ Does the analogous rule for $\TrCirc{s}{-}$ follow? }
...
\drlnote{Equation for $\Sigma$ types}
...
\St{s}{\U{c.\mu}{A}{B}} &\equiv \U{c.\mu[\TrCirc{s}{c}/c]}{A}{B} \\
\U{c.\mu}{x:A}{\St{s}{B}} &\equiv \U{c.\TrCirc{s}{\mu}}{A}{B} \\
\U{c.\mu}{x:\St{s}{A}}{B} &\equiv \U{c.\mu[\TrPlus{s}{x}/x]}{A}{B} \\
\St{(\telety{x}{s}{t})}{\telety{x}{A}{B}} & \equiv \telety{x}{\St{s}{A}}{???} \\
