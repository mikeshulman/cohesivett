...
\equiv{} &\StE{\chi}{\rewrite{\eta^\chi_\delta}{(\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}},\upstairs{\qpair{A,B}})}}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\delta}}{\StI{\ApEl{p}{\eta^\chi_\delta}}{\StE{\chi}{(\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}},\upstairs{\qpair{A,B}})}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\delta}}{\StI{\ApEl{p}{\eta^\chi_\delta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}[\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qpair{A,B}}/s]}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\delta}}{\StI{\ApEl{p}{\eta^\chi_\delta}}{\FEs{w. \Sigma_1(\delta,\fst w, \snd w)}{\upstairs{\qpair{A,B}}}{x, y}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}}}}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\delta}}{\StI{\ApEl{p}{\eta^\chi_\delta}}{\FEs{w. \Sigma_1(\delta,\fst w, \snd w)}{\rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{\One_\delta}}{\delta}/\delta])}}}{x, y}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}}}}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta})}}{\StI{\ApEl{p}{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta})}}{\FEs{w. \Sigma_1(\delta,\fst w, \snd w)}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{\One_\delta}}{\delta}/\delta])}}{x, y}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}}}}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta})}}{\StI{\ApEl{p}{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta})}}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}}[\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{\One_\delta}}{\delta}/\delta]/y]}} \\
...
\end{align*}
Now thankfully we verified in Lemma~\ref{lem:double-into} that
\begin{align*}
&\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{\One_\delta}}{\delta}/\delta]/y] \\
&\equiv \rewrite{\pi^{\delta.\One_\delta}_{\One_{\delta.\One_\delta}};\pi^{\delta}_{\One_{\delta}}}{\delta}
\end{align*}
So we are left with:
\begin{align*}
&\rewrite{\ApOne{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,\One_{\delta},\One_{\delta.\One_\delta}}}}{\StI{\ApEl{p}{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,\One_{\delta},\One_{\delta.\One_\delta}}}}{\upstairs{c}[\rewrite{\pi^{\delta.\One_\delta}_{\One_{\delta.\One_\delta}};\pi^{\delta}_{\One_{\delta}}}{\delta}/\delta]}} \\
&\equiv \rewrite{\ApOne{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,\One_{\delta},\One_{\delta.\One_\delta}};\pi^{\delta.\One_\delta}_{\One_{\delta.\One_\delta}};\pi^{\delta}_{\One_{\delta}}}}{\StI{\ApEl{p}{\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,\One_{\delta},\One_{\delta.\One_\delta}};\pi^{\delta.\One_\delta}_{\One_{\delta.\One_\delta}};\pi^{\delta}_{\One_{\delta}}}}{\upstairs{c}}} \\
\end{align*}
And finally
\begin{align*}
&\eta^\chi_\delta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,\One_{\delta},\One_{\delta.\One_\delta}};\pi^{\delta.\One_\delta}_{\One_{\delta.\One_\delta}};\pi^{\delta}_{\One_{\delta}} \\
&\equiv \eta^\chi_\delta;(\id_\delta \bdot \contract{\delta});\pi^{\delta}_{\Sigma_1(\One_{\delta},\One_{\delta.\One_\delta})} \\
&\equiv \id_\delta
\end{align*}
...
&\equiv \upstairs{C}[\rewrite{\eta^\chi_{\TrPlus{f}{\alpha.x}};(\ApPlus{f}{\pi^\alpha_x} \bdot \fone{\alpha.x};\ap{f_1}{\var{x}};\ap{f_1}{\pi^\alpha_x/\alpha, \id / x})}{\StI{\chi}{\StI{f}{\alpha}, \FIs{f_1}{x}}}/\delta] \\
...
\end{align*}
In the middle we use the following identity:
\begin{align*}
&\FIs{f_1}{\StI{\ApEl{p}{\pi^\alpha_x}}{x}} \\
&\equiv \FIs{f_1}{x[\rewrite{\pi^\alpha_x}{\alpha}/\alpha]} \\
&\equiv \FIs{f_1}{x}[\rewrite{\pi^\alpha_x}{\alpha}/\alpha, x / x] \\
&\equiv \rewrite{\ap{f_1}{\pi^\alpha_x/\alpha, \id / x}}{\FIs{f_1}{x}}
\end{align*}
\mvrnote{Of course $x[\dots/\alpha]$ looks a bit odd, but the type of $x$ is modified by that}
