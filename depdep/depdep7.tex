...
\newcommand{\upstairsu}[1]{\widehat{#1}}

% Taken from https://tex.stackexchange.com/questions/241814/an-underhat-and-underwidehat
...
\newcommand{\downstairsu}[1]{\uwidehat{#1}}
...
The general schema is as follows: context formers are specified by mode type morphisms, structural rules are specified by mode term morphisms and type formers are specified by mode terms. We give an example of each of these in turn. \mvrnote{TODO: also include some examples of how these translations would look if the mode theory were very strict} \mvrnote{TODO: these are out of date now}
...
\end{align*}
where the final steps fuse the rewrites and use a triangle identity for $\eta$ and $\pi$.  \mvrnote{(FIXME: give this a label and insert reference)}
...
For future use we record the following identities:
...
\begin{lemma}
The substitution $\proj{\Gamma, A, B};\proj{\Gamma, A}$ is translated to the term
\begin{align*}
\delta : \upstairs{\Gamma, A, B} \yields_\delta \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pi^{\alpha.x}_y;\pi^\alpha_x}{\alpha}}} : \upstairs{\Gamma}
\end{align*}
\end{lemma}
\begin{proof}
\begin{align*}
&\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}} \\
&\equiv \upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta] \\
&\equiv \upstairs{\proj{\Gamma, A}}[\StE{\chi}{\delta}{\beta,y}{\rewrite{\pi^\beta_y}{\beta}}/\beta] \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\upstairs{\proj{\Gamma, A}}[\rewrite{\pi^\beta_y}{\beta}/\beta]} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\upstairs{\proj{\Gamma, A}}[\rewrite{\pi^\beta_y}{\beta}/\beta]} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{(\StE{\chi}{\beta}{\alpha, x}{\rewrite{\pi^\alpha_x}{\alpha}})[\rewrite{\pi^\beta_y}{\beta}/\beta]} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{(\StE{\chi}{\beta}{\alpha, x}{\rewrite{\pi^\alpha_x}{\alpha}})[\rewrite{\pi^\beta_y}{\beta}/\beta]} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\rewrite{\pi^\beta_y}{\beta}}{\alpha, x}{\rewrite{\pi^\alpha_x}{\alpha}}} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pi^{\alpha.x}_y;\pi^\alpha_x}{\alpha}}}
\end{align*}
\end{proof}
...
{\beta : \upstairs{\Gamma, \One_\Gamma} \yields_{\One_{\beta}} \StE{\chi}{\beta}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}} : \upstairs{C}}
\end{mathpar}
\end{enumerate}
...
&\equiv (\StE{\chi}{\beta}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}})[\upstairs{\Theta \uparrow \One_\Gamma}/\beta] \\
&\equiv \StE{\chi}{\beta}{\alpha, s}{(\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}})[\upstairs{\Theta}/\alpha, s/s]}} \\
&\equiv \StE{\chi}{\beta}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}[\upstairs{\Theta}/\alpha]}}}} \\
...
&\equiv (\StE{\chi}{\beta}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}})[\upstairs{\id_\Gamma, \star_\Gamma}/\beta] \\
&\equiv \StE{\chi}{\upstairs{\id_\Gamma, \star_\Gamma}}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}} \\
&\equiv \StE{\chi}{\rewrite{\eta^\chi_\alpha}{\StI{\chi}{\alpha, \upstairs{\star_\Gamma}}}}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}} \\
&\equiv \rewrite{\ApOne{\eta^\chi_\alpha}}{\StI{\ApEl{p}{\eta^\chi_\alpha}}{\StE{\chi}{\StI{\chi}{\alpha, \upstairs{\star_\Gamma}}}{\alpha, s}{\FEs{w.\One_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}}}} \\
&\equiv \rewrite{\ApOne{\eta^\chi_\alpha}}{\StI{\ApEl{p}{\eta^\chi_\alpha}}{\FEs{w.\One_\alpha}{\upstairs{\star_\Gamma}}{w}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}}} \\
&\equiv \rewrite{\ApOne{\eta^\chi_\alpha}}{\StI{\ApEl{p}{\eta^\chi_\alpha}}{\rewrite{\ApOne{\pi^\alpha_{\One_\alpha}}}{\StI{\pi^\alpha_{\One_\alpha}}{\upstairs{c}}}}} \\
&\equiv \upstairs{c}
\end{align*}
\end{enumerate}
...
\item[\textsc{$\Sigma$-pair}] The type is
\begin{align*}
&\upstairs{(\Sigma_A B)[\proj{\Gamma, A, B};\proj{\Gamma, A}]} \\
&\equiv \upstairs{\Sigma_A B}[\upstairs{\proj{\Gamma, A,B};\proj{\Gamma, A}}/\alpha] \\
&\equiv \upstairs{\Sigma_A B}[\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pi^{\alpha.x}_y;\pi^\alpha_x}{\alpha}}}/\alpha] \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\upstairs{\Sigma_A B}[\rewrite{\pi^{\alpha.x}_y;\pi^\alpha_x}{\alpha}]}} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\St{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\upstairs{\Sigma_A B}}}}
\end{align*}
And we can produce a term by:
\begin{mathpar}
\inferrule*[Left=s-elim]{
\inferrule*[Left=s-elim]{
\inferrule*[Left=rewrite]{
\inferrule*[Left=F-intro]{
\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\Sigma(x,y)} \FIs{w. \Sigma_1(\fst w, \snd w)}{x,y} : \upstairs{\Sigma_A B}
}{
\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\TrPlus{\ApEl{p}{\pi^\alpha_x}}{\Sigma!(x,y)}} \StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}} : \St{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\upstairs{\Sigma_A B}}}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\One_{\alpha.x.y}}\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}} : \St{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\upstairs{\Sigma_A B}}}}
{\beta : \upstairs{\Gamma, A}, y : \upstairs{B} \yields_{\One_{\beta.y}} \StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}} : \dots}}
{\delta : \upstairs{\Gamma, A, B} \yields_{\One_{\delta}} \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}} : \upstairs{\Sigma_A B [\proj{\Gamma,A,B};\proj{\Gamma, A}]}}}
\end{mathpar}
...
\equiv{} &\rewrite{\eta^\chi_\delta}{\StI{\chi}{
\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pi^{\alpha.x}_y;\pi^\alpha_x}{\alpha}}}, \\
&\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\eta^\chi_{\alpha.x.y}}{\StI{\chi}{(\rewrite{\pi^{\alpha.x}_y;\pi^\alpha_x}{\alpha},\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}})}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\eta^\chi_{\alpha.x.y}}{\StI{\chi}{\rewrite{(\pi^{\alpha.x}_y;\pi^\alpha_x,\fibpair{x,y})}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\eta^\chi_{\alpha.x.y};(\pi^{\alpha.x}_y;\pi^\alpha_x \bdot \fibpair{x,y})}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pair{x,y}}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}}
\end{align*}
So the type $\upstairs{C[(\proj{\Gamma, A, B};\proj{\Gamma, A}), \qpair{A,B}]}$ is translated to:
\begin{align*}
&\upstairs{C[(\proj{\Gamma, A, B};\proj{\Gamma, A}), \qpair{A,B}]} \\
&\equiv \upstairs{C}[\upstairs{(\proj{\Gamma, A, B};\proj{\Gamma, A}), \qpair{A,B}}/\beta] \\
&\equiv \upstairs{C}[\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pair{x,y}}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}}/\beta] \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\upstairs{C}[\rewrite{\pair{x,y}}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}/\beta]} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\St{\ApEl{p}{\pair{x,y}}}{\upstairs{C}[\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}/\beta]}}
\end{align*}
So as our translation use:
\begin{mathpar}
\inferrule*[Left=s-elim]{
...
{\alpha : \upstairs{\Gamma}, s : \upstairs{\Sigma_A B}\yields_{\One_{\alpha.s}} \FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x,y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}} : \upstairs{C}[\StI{\chi}{(\alpha, s)}/\beta]}
}
{
\beta : \upstairs{\Gamma, \Sigma_A B} \yields_{\One_\beta} \StE{\chi}{\beta}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}} : \upstairs{C}
}
\end{mathpar}
\mvrnote{Or because I can't figure out how to split lines in mathpar}
\begin{align*}
&\StE{\chi}{\beta}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}
\end{align*}
\end{enumerate}
...
\equiv{} &(\StE{\chi}{\beta}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}})[\upstairs{(\proj{\Gamma, A, B};\proj{\Gamma, A}),\qpair{A,B}}/\beta] \\
\equiv{} &\StE{\chi}{\upstairs{(\proj{\Gamma, A, B};\proj{\Gamma, A}),\qpair{A,B}}}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}} \\
\equiv{} &\StE{\chi}{(\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pair{x,y}}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}})}{\alpha, s}{\\&\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\StE{\chi}{\rewrite{\pair{x,y}}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}{\alpha, s}{\\&\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\One_{\pair{x,y}}}{\StI{\ApEl{p}{\pair{x,y}}}{\StE{\chi}{\StI{\chi}{\alpha,\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}{\alpha, s}{\\&\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\One_{\pair{x,y}}}{\StI{\ApEl{p}{\pair{x,y}}}{\\&\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\One_{\pair{x,y}}}{\StI{\ApEl{p}{\pair{x,y}}}{\\&\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}}} \\
\equiv{} &\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}} \\
\equiv{} &\upstairs{c}
\end{align*}
...
&\equiv \left(\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}}\right)[\upstairs{\Theta \uparrow A \uparrow B}/\delta] \\
&\equiv \left(\StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}}\right)[\upstairs{\Theta \uparrow A \uparrow B}/\delta] \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{(\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}})[\upstairs{\Theta}/\alpha,x/x,y/y]}} \\
&\equiv \StE{\chi}{\delta}{\beta,y}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^\alpha_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}} \\
&\equiv \qpair{A[\Theta], B[\Theta \uparrow A]}
\end{align*}
by Lemma~\ref{lem:match-uparrow}.
\mvrnote{This looks a bit silly because we reuse $\alpha$}

\item[{$\qsplit{A,B}(c)[\Theta \uparrow \Sigma_A B] \equiv \qsplit{A[\Theta],B[\Theta \uparrow A]}(c[\Theta \uparrow A \uparrow B])$}:]

Using Lemma~\ref{lem:match-uparrow} and Lemma~\ref{lem:into-identities}:
\begin{align*}
&\upstairs{\qsplit{A,B}(c)[\Theta \uparrow \Sigma_A B]} \\
\equiv{} &\upstairs{\qsplit{A,B}(c)}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
\equiv{} &\StE{\chi}{\beta}{\alpha, s}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\\&\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}}}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
\equiv{} &\StE{\chi}{\beta}{\alpha, s}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\\&\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\Theta}/\alpha]}}})} \\
\equiv{} &\StE{\chi}{\beta}{\alpha, s}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{x, y}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\\&\upstairs{c}[\upstairs{\Theta \uparrow A \uparrow B}/\alpha][\into{\Delta, A[\Theta], B[\Theta \uparrow A]}[\into{\Delta, A[\Theta]}/\beta, y/y] /\delta]}}})} \\
...
The rules for $\Pi$ types are given in Figure~\ref{fig:qit-pi-rules}. Stability of $\mathsf{app}$ under substitution is derivable from stability of $\qlam{}$ using beta and eta: \mvrnote{This is much, much more confusing because of the axiomatic $\mathsf{app}$. We need to use an exchange substitution to even get this to work, TODO}
...
\inferrule*[left=$\Pi$-elim]{~}{\Gamma, A, (\Pi_A B)[\proj{\Gamma, A}] \qyields \qapp{A, B} : B[\proj{\Gamma, A, (\Pi_A B)[\proj{\Gamma, A}]}]}
\end{mathpar}
\begin{align}
...
\subsection{Unpacked Translation}


In the above translation of MLTT we have chosen to interpret contexts $\Gamma$ as framework types $\upstairs{\Gamma} \TYPE_p$ rather than framework contexts. With the packed translation of contexts above, an object-level substitution $\Theta$ becomes a term $\alpha : \upstairs{\Gamma} \yields_\alpha \upstairs{\Theta} : \upstairs{\Delta}$, where the types on either side encode the dependency structure of each object-level context. The issue with translating contexts $\Gamma$ as framework contexts $\upstairsu{\Gamma} \CTX_{\downstairsu{\Gamma}}$ is that in the translation of a substitution $\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \upstairsu{\Delta}$, the dependency structure of $\Gamma$ is encoded in the mode terms $\modeof{\Gamma}$, but there is no part of the judgement that encodes the dependency structure of $\Delta$.

This can be resolved if we translate a substitution as a single term $\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \upstairs{\Delta}$, where $\upstairs{\Delta}$ is the translation of $\Delta$ into a framework type as in the previous section. The drawback of this is that performing object-level substitution into types and terms is no longer simply framework-level substitution, and similarly composition of object-level substitutions is not translated to composition of framework substitutions.

In this section we give a translation where contexts remain unpacked where possible.

\begin{itemize}
\item A context $\qyields \Gamma \CTX$ is represented by a framework context $\upstairsu{\Gamma}$ over mode context $\downstairsu{\Gamma}$, together with a mode type morphism $\cdot \yields \tpack{\Gamma} : p \tcell \ctxtuple{\downstairsu{\Gamma}}$ where $\ctxtuple{\downstairsu{\Gamma}}$ is the iterated telescope type of Lemma~\ref{lem:ctxtuple}.
\item A type $\Gamma \qyields A \TYPE$ is represented by a framework type $\upstairsu{\Gamma} \yields_{\El{p}{\modeof{\Gamma}}} \upstairsu{A} \TYPE$, where
\begin{align*}
\downstairsu{\Gamma} \yields \modeof{\Gamma} :\equiv \TrPlus{\tpack{\Gamma}}{\ctxtuple{\id_{\downstairsu{\Gamma}}}} : p
\end{align*}
Note that $\ctxtuple{\id_{\downstairsu{\Gamma}}}$ is simply an iterated tuple of the variables of $\downstairsu{\Gamma}$ in order: $(((((), x), y), z), \dots)$.
\item A term $\Gamma \qyields a : A$ is represented by a framework term $\upstairsu{\Gamma} \yields_{\One_{\modeof{\Gamma}}} \upstairsu{a} : \upstairsu{A}$.
\item A substitution $\Gamma \qyields \Theta : \Delta$ is represented by a term $\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \St{\mathtt{pack}_\Delta}{\ctxtuple{\upstairsu{\Delta}}}$
\end{itemize}

The structural rules of MLTT then have the following translations:
\begin{enumerate}
\item[\textsc{ctx-empty}] Define $\upstairsu{(\cdot)}$ to be the empty framework context and $\tpack{(\cdot)} :\equiv \psi : p \tcell 1$, noting that $\ctxtuple{(\cdot)} \equiv 1$.

\item[\textsc{ctx-ext}] Given $\upstairsu{\Gamma}
  \yields_{\El{p}{\modeof{\Gamma}}} \upstairsu{A} \TYPE$, define $\upstairsu{\Gamma, A}$ to be the extended framework context $\upstairsu{\Gamma}, x : \upstairsu{A}$. We need to specify a mode type morphism $\tpack{\Gamma, A} : p \tcell \ctxtuple{(\downstairsu{\Gamma, A})}$. 
  By definition,
  \begin{align*}
    \ctxtuple{(\downstairsu{\Gamma, A})} \equiv \sum_{\sigma : \ctxtuple{\downstairsu{\Gamma}}} \modeof{\Gamma}[\fan{\sigma}]
  \end{align*}
  and note that 
  \begin{align*}
  \modeof{\Gamma}[\fan{\sigma}]
  &\equiv \TrPlus{\tpack{\Gamma}}{\ctxtuple{\id_{\downstairsu{\Gamma}}}}[\fan{\sigma}] \\
  &\equiv \TrPlus{\tpack{\Gamma}}{\ctxtuple{\id_{\downstairsu{\Gamma}}}[\fan{\sigma}]} \\
  ...
  \begin{align*}
  \sigmacl{\sigma}{\tpack{\Gamma}}{\id_{\TrPlus{\tpack{\Gamma}}{\sigma}}} : \sigmacl{\sigma}{p}{\El{p}{\sigma}} \tcell \sigmacl{\sigma}{\ctxtuple{\downstairsu{\Gamma}}}{\TrPlus{\tpack{\Gamma}}{\sigma}}
  \end{align*}
...
\item[\textsc{type-sub}] Given $\upstairsu{\Delta} \yields_{\El{p}{\modeof{\Delta}}} \upstairsu{A} \TYPE$ and $\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \St{\mathtt{pack}_\Delta}{\ctxtuple{\upstairsu{\Delta}}}$, we can form:
\begin{align*}
\upstairsu{\Gamma} \yields_{\El{p}{\modeof{\Gamma}}} \upstairsu{A[\Theta]} :\equiv \StE{\tpack{\Delta}}{\upstairsu{\Theta}}{\sigma}{\upstairsu{A}[\fan{\Delta}]}
\end{align*}

\item[\textsc{term-sub}] Similarly, given $\upstairsu{\Delta} \yields_{\El{p}{\One_{\modeof{\Delta}}}} \upstairsu{a} : \upstairsu{A} \TYPE$ and $\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \St{\mathtt{pack}_\Delta}{\ctxtuple{\upstairsu{\Delta}}}$, we can form:
\begin{align*}
\upstairsu{\Gamma} \yields_{\El{p}{\modeof{\Gamma}}} \upstairsu{a[\Theta]} :\equiv \StE{\tpack{\Delta}}{\upstairsu{\Theta}}{\sigma}{\upstairsu{a}[\fan{\Delta}]}
\end{align*}
...
\begin{align*}
\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\epsilon_\Gamma} : \St{\tpack{(\cdot)}}{\ctxtuple{(\cdot)}}
\end{align*}
...
\begin{align*}
\upstairsu{\epsilon_\Gamma} :\equiv \rewrite{\eta^\psi_{\modeof{\Gamma}}}{\StI{\psi}{}}
\end{align*}

\item[\textsc{sub-ext}] We are provided
\begin{align*}
\upstairsu{\Gamma} &\yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \St{\mathtt{pack}_\Delta}{\ctxtuple{\upstairsu{\Delta}}} \\
\upstairsu{\Gamma} &\yields_{\One_{\modeof{\Gamma}}} \upstairsu{a} : \upstairsu{A[\Theta]}
\end{align*}
and we are trying to define:
\begin{align*}
\upstairsu{\Gamma} &\yields_{\modeof{\Gamma}} \upstairsu{\Theta, a} : \St{\tpack{\Delta, A}}{\ctxtuple{\upstairsu{\Delta, A}}}
\end{align*}
Unfolding definitions:
\begin{align*}
\upstairsu{A[\Theta]}
&\equiv \StE{\tpack{\Delta}}{\upstairsu{\Theta}}{\sigma}{\upstairsu{A}[\fan{\Delta}]}
\intertext{and}
\St{\tpack{\Delta, A}}{\ctxtuple{\upstairsu{\Delta, A}}}
&\equiv \St{(\chi ; (\sigmacl{\sigma}{\tpack{\Delta}}{\id_{\TrPlus{\tpack{\Delta}}{\sigma}}}))}{\ctxtuple{\upstairsu{\Delta}}, \upstairsu{A}[\fan{\Delta}]} \\
&\equiv \St{\chi}{\St{\sigmacl{\sigma}{\tpack{\Delta}}{\id_{\TrPlus{\tpack{\Delta}}{\sigma}}}}{\ctxtuple{\upstairsu{\Delta}}, \upstairsu{A}[\fan{\Delta}]}} \\
&\equiv \St{\chi}{\sigma' : \St{\tpack{\Delta}}{\ctxtuple{\upstairsu{\Delta}}}, \StE{\tpack{\Delta}}{\sigma'}{\sigma}{\upstairsu{A}[\fan{\Delta}]}}
\end{align*}
So we can form:
\begin{align*}
\upstairsu{\Theta, a} :\equiv \rewrite{\eta^\chi_{\modeof{\Gamma}}}{\StI{\chi}{\upstairsu{\Theta}, \upstairsu{A}}}
\end{align*}

\item[\textsc{sub-id}] We have:
\begin{align*}
\upstairsu{\Gamma} \yields_{\modeof{\Gamma}} \upstairsu{\id_\Gamma} :\equiv \StI{\tpack{\Gamma}}{\ctxtuple{\id_{\upstairsu{\Gamma}}}} : \St{\tpack{\Gamma}}{\ctxtuple{\upstairsu{\Gamma}}}
\end{align*}
...
\begin{align*}
\upstairsu{\Gamma} &\yields_{\modeof{\Gamma}} \upstairsu{\Theta} : \St{\mathtt{pack}_\Delta}{\ctxtuple{\upstairsu{\Delta}}} \\
\upstairsu{\Delta} &\yields_{\modeof{\Delta}} \upstairsu{\kappa} : \St{\mathtt{pack}_\Lambda}{\ctxtuple{\upstairsu{\Lambda}}}
\end{align*}
we can form
\begin{align*}
\upstairsu{\Theta;\kappa} :\equiv \StE{\tpack{\Delta}}{\upstairsu{\Theta}}{\sigma}{\upstairsu{\kappa}[\fan{\upstairsu{\Delta}}]}
\end{align*}

\item[\textsc{sub-proj}] We are trying to construct a term
\begin{align*}
\upstairsu{\Gamma}, x : \upstairsu{A} \yields_{\modeof{(\Gamma, A)}} \upstairsu{\proj{\Gamma, A}} : \St{\mathtt{pack}_\Gamma}{\ctxtuple{\upstairsu{\Gamma}}}
\end{align*}
with mode
\begin{align*}
\modeof{(\Gamma, A)}
&\equiv \TrPlus{\tpack{(\Gamma, A)}}{\ctxtuple{\id_{\downstairsu{(\Gamma, A)}}}} \\
&\equiv \TrPlus{(\chi ; (\sigmacl{\sigma}{\tpack{\Gamma}}{\id_{\TrPlus{\tpack{\Gamma}}{\sigma}}}))}{\ctxtuple{\id_{\downstairsu{\Gamma}}}, x} \\
&\equiv \TrPlus{\chi}{\TrPlus{\tpack{\Gamma}}{\ctxtuple{\id_{\downstairsu{\Gamma}}}}, x} \\
&\equiv \TrPlus{\chi}{\modeof{\Gamma}, x} \\
&\equiv \modeof{\Gamma}.x
\end{align*}
So define:
\begin{align*}
\upstairsu{\proj{\Gamma, A}} :\equiv \rewrite{\pi^{\modeof{\Gamma}}_x}{\upstairsu{\id_\Gamma}}
\end{align*}

\item[\textsc{var}] We are a building a term
\begin{align*}
\upstairsu{\Gamma}, x : \upstairsu{A} \yields_{\One_{\modeof{(\Gamma, A)}}} \upstairsu{\qvar{\Gamma, A}} : \upstairsu{A[\proj{\Gamma, A}]}
\end{align*}
The type in question simplifies:
\begin{align*}
\upstairsu{A[\proj{\Gamma, A}]}
&\equiv \StE{\tpack{\Gamma}}{\upstairsu{\proj{\Gamma, A}}}{\sigma}{\upstairsu{A}[\fan{\Gamma}]} \\
&\equiv \StE{\tpack{\Gamma}}{\rewrite{\pi^{\modeof{\Gamma}}_x}{\upstairsu{\id_\Gamma}}}{\sigma}{\upstairsu{A}[\fan{\Gamma}]} \\
&\equiv \St{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{\StE{\tpack{\Gamma}}{\upstairsu{\id_\Gamma}}{\sigma}{\upstairsu{A}[\fan{\Gamma}]}} \\
&\equiv \St{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{\StE{\tpack{\Gamma}}{\StI{\tpack{\Gamma}}{\ctxtuple{\id_{\upstairsu{\Gamma}}}}}{\sigma}{\upstairsu{A}[\fan{\Gamma}]}} \\
&\equiv \St{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{\upstairsu{A}[\fan{\Gamma}][\ctxtuple{\id_{\upstairsu{\Gamma}}}/\sigma]} \\
&\equiv \St{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{\upstairsu{A}}
\end{align*}

So define $\upstairsu{\qvar{\Gamma, A}}$ by:
\begin{align*}
\upstairsu{\qvar{\Gamma, A}} : \rewrite{\qvar{x}}{\StI{\ApEl{p}{\pi^\alpha_x}}{x}}
\end{align*}
\end{enumerate}
...
\begin{align*}
\upstairs{\Rtype{A}} :\equiv \U{f_1}{1}{\upstairs{A}[\StI{f}{\alpha}/\beta]}
\end{align*}
...
\begin{lemma}
The substitution $\proj{\Gamma, A}, \lock$ is translated to the term
\begin{align*}
\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\StI{f}{\rewrite{\pi^\alpha_x}{\alpha}}}} : \upstairs{\Gamma, \lock}
\end{align*}
\end{lemma}
\begin{proof}
\mvrnote{same as always}
\end{proof}
...
\item[\textsc{L-intro}] Our goal is a term in context $\delta : \upstairs{\Gamma, A, \lock}$ of type:
\begin{align*}
&\equiv \upstairs{\Ltype{A}}[\upstairs{\proj{\Gamma, A}, \lock}/\beta] \\
&\equiv \upstairs{\Ltype{A}}[\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\StI{f}{\rewrite{\pi^\alpha_x}{\alpha}}}}/\beta] \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{(\StE{f}{\beta}{\alpha}{\F{f_1}{\upstairs{A}}})[\StI{f}{\rewrite{\pi^\alpha_x}{\alpha}}/\beta]}} \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{(\StE{f}{\StI{f}{\rewrite{\pi^\alpha_x}{\alpha}}}{\alpha}{\F{f_1}{\upstairs{A}}})}} \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\F{f_1}{\upstairs{A}}[\rewrite{\pi^\alpha_x}{\alpha}/\alpha]}} \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\St{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\F{f_1}{\upstairs{A}}}}}
\end{align*}
...
\inferrule*[Left=s-intro]{
\inferrule*[Left=F-intro]{
\alpha : \upstairs{\Gamma}, x : \upstairs{A} \yields_x x : \upstairs{A}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A} \yields_{f_1(x)} \FIs{f_1}{x} : \F{f_1}{\upstairs{A}}}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A} \yields_{\TrPlus{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{f_1(x)}} \StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}} : \St{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\F{f_1}{\upstairs{A}}}}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A} \yields_{\One_{\TrPlus{f}{\alpha.x}}} \rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}} : \St{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\F{f_1}{\upstairs{A}}}}}
{\beta : \upstairs{\Gamma, A} \yields_{\One_{\TrPlus{f}{\beta}}} \StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}} : \dots}}
{\delta : \upstairs{\Gamma, A, \lock} \yields_{\One_\delta} \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}}} : \upstairs{\Ltype{A}[\proj{\Gamma, A}, \lock]}}
\end{mathpar}

\item[\textsc{L-elim}] We are given a term $\upstairs{c} : \upstairs{C[\proj{\Gamma, A}, \lock, \LI{A}]}$. 

The substitution $\proj{\Gamma, A}, \lock, \LI{A}$ is translated to 
\begin{align*}
&\upstairs{\proj{\Gamma, A}, \lock, \LI{A}} \\
\equiv{} &\rewrite{\eta^\chi_\delta}{\StI{\chi}{\upstairs{\proj{\Gamma, A}, \lock}, \upstairs{\LI{A}}}} \\
\equiv{} &\rewrite{\eta^\chi_\delta}{\StI{\chi}{\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\StI{f}{\rewrite{\pi^\alpha_x}{\alpha}}}}, \\& \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\eta^\chi_{\TrPlus{f}{\alpha.x}}}{\StI{\chi}{\StI{f}{\rewrite{\pi^\alpha_x}{\alpha}}, \rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\eta^\chi_{\TrPlus{f}{\alpha.x}}}{\StI{\chi}{\rewrite{\ApPlus{f}{\pi^\alpha_x}}{\StI{f}{\alpha}}, \rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\eta^\chi_{\TrPlus{f}{\alpha.x}};(\ApPlus{f}{\pi^\alpha_x} \bdot \fibf{x})}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fdist{\alpha,x}}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}}}}
\end{align*}
So $\upstairs{c}$ has type 
\begin{align*}
&\upstairs{C}[\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fdist{\alpha,x}}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}}}}/\delta] \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\upstairs{C}[\rewrite{\fdist{\alpha,x}}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}}/\delta]}} \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\St{\ApEl{q}{\fdist{\alpha,x}}}{\upstairs{C}[\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}/\delta]}}}
\end{align*}
...
&\equiv (\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}}})[\upstairs{\Theta \uparrow A, \lock}/\delta] \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}[\upstairs{\Theta}/\alpha, x / x]}} \\
&\equiv \StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fibf{x}}{\StI{\ApEl{q}{\ApPlus{f}{\pi^\alpha_x}}}{\FIs{f_1}{x}}}}} \\
...
\equiv{} &\StE{\chi}{(\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\fdist{\alpha,x}}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}}}})}{\beta, x'}{\StE{f}{\beta}{\alpha}{\\&\FE{x'}{x}{\rewrite{\ApOne{\fdistinv{\alpha,x}}}{\StI{\fdistinv{\alpha,x}}{\upstairs{c}[\StI{f}{\into{\Gamma, A}}/\delta]}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\StE{\chi}{\rewrite{\fdist{\alpha,x}}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}}})}{\beta, x'}{\StE{f}{\beta}{\alpha}{\\&\FE{x'}{x}{\rewrite{\ApOne{\fdistinv{\alpha,x}}}{\StI{\fdistinv{\alpha,x}}{\upstairs{c}[\StI{f}{\into{\Gamma, A}}/\delta]}}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\ApOne{\fdist{\alpha,x}}}{\StI{\ApEl{q}{\fdist{\alpha,x}}}{\StE{\chi}{\StI{\chi}{\StI{f}{\alpha},\FIs{f_1}{x}})}{\beta, x'}{\StE{f}{\beta}{\alpha}{\\&\FE{x'}{x}{\rewrite{\ApOne{\fdistinv{\alpha,x}}}{\StI{\fdistinv{\alpha,x}}{\upstairs{c}[\StI{f}{\into{\Gamma, A}}/\delta]}}}}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\ApOne{\fdist{\alpha,x}}}{\StI{\ApEl{q}{\fdist{\alpha,x}}}{\StE{f}{\StI{f}{\alpha}}{\alpha}{\\&\FE{\FIs{f_1}{x}}{x}{\rewrite{\ApOne{\fdistinv{\alpha,x}}}{\StI{\fdistinv{\alpha,x}}{\upstairs{c}[\StI{f}{\into{\Gamma, A}}/\delta]}}}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\rewrite{\ApOne{\fdist{\alpha,x}}}{\StI{\ApEl{q}{\fdist{\alpha,x}}}{\rewrite{\ApOne{\fdistinv{\alpha,x}}}{\StI{\fdistinv{\alpha,x}}{\upstairs{c}[\StI{f}{\into{\Gamma, A}}/\delta]}}}}}} \\
\equiv{} &\StE{f}{\delta}{\beta}{\StE{\chi}{\beta}{\alpha,x}{\upstairs{c}[\StI{f}{\into{\Gamma, A}}/\delta]}} \\
\equiv{} &\upstairs{c}
\end{align*}
\end{enumerate}
...
We can interpret the rules of $\flat$ without assuming $f$ is idempotent. These are only slightly modified from the translations of $\Ltype{}$.
...
\item[\textsc{$\flat$-intro}] We are given 
\begin{align*}
\beta : \upstairs{\Gamma, \lock} \yields_{\One_\beta} \upstairs{a} : \upstairs{A}
\end{align*}
and we can mirror the formation rule
\begin{mathpar}
\inferrule*[Left=s-elim]{
\inferrule*[Left=rewrite]{
\inferrule*[Left=F-intro]{
...
\beta : \upstairs{\Gamma, \lock} \yields_{\One_\beta} \upstairs{a} : \upstairs{A} }
{\alpha : \upstairs{\Gamma} \yields_{\One_{\TrPlus{f}{\alpha}}} \upstairs{a}[\StI{f}{\alpha}/\beta] : \upstairs{A}[\StI{f}{\alpha}/\beta]}}
{\alpha : \upstairs{\Gamma} \yields_{\flat_1(\One_{\TrPlus{f}{\alpha}})} \FI{\upstairs{a}[\StI{f}{\alpha}/\beta]} : \F{\flat_1}{\upstairs{A}[\StI{f}{\alpha}/\beta]}}}
{\alpha : \upstairs{\Gamma} \yields_{\One_{\TrPlus{f}{\alpha}}} \rewrite{\flatone{\alpha}}{\FI{\upstairs{a}[\StI{f}{\alpha}/\beta]}} : \F{\flat_1}{\upstairs{A}[\StI{f}{\alpha}/\beta]}}}
{\beta : \upstairs{\Gamma, \lock} \yields_{\One_\beta} \StE{f}{\beta}{\alpha}{\rewrite{\flatone{\alpha}}{\FI{\upstairs{a}[\StI{f}{\alpha}/\beta]}}} : \upstairs{\Flattype{A}}}
\end{mathpar}

\item[\textsc{$\flat$-elim}] \mvrnote{TODO, not anticipating any surprises}
\end{enumerate}
...
\mvrnote{DILTT} maintains the invariant that all types in the linear zone are well-formed in the intuitionistic context. A DILTT context $\Gamma \mid A, B, \dots$ is translated to a framework context $\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}, \dots$, where $\Gamma$ is translated as in ordinary MLTT, we may do this because each of the types $\upstairs{A}, \upstairs{B}, \dots$ are well-formed in context $\alpha : \upstairs{\Gamma}$.

The rules in algebraic style are given in Figure~\ref{fig:qit-linear-dependent-rules}. Rules such as $\Sigma!$-elim and $\Pi!$-intro are presented with only a single linear type $\Xi$ in the linear context. In the presence of $\otimes$-types, we may pack a more general linear context into a single type iterated $\otimes$-type, apply the rule, then unpack the $\otimes$-type.

\begin{figure}
\mvrnote{TODO: need a different symbol for $\CTX$ when referring to the dual one}
\mvrnote{TODO: what is the proper way of defining term-lin-sub? this single variable version? or a second substitution judgement with a linear context?}
\begin{mathpar}
...
\inferrule*[left=term-lin-sub]{\Gamma \mid \Xi, B \qyields a : A  \and \Gamma \mid \Xi' \qyields b : B}{\Gamma \mid \Xi, \Xi' \qyields a[b/B] : A} \\
\inferrule*[left=ctx-var]{~}{\Gamma, A \mid \cdot \qyields \qvar{A} : A[\proj{\Gamma, A}]} \and
\inferrule*[left=ctx-lin-var]{~}{\Gamma \mid A \qyields \qlinvar{A} : A} 
\end{mathpar}
\begin{align}
a[\qlinvar{A}/A] &\equiv a
\end{align}
\mvrnote{associativity, etc}
\begin{mathpar}
%\inferrule*[left=sub-lin-empty]{\Gamma \qyields \Theta : \Delta \and \Gamma \qyields a : A[\Theta]}{\Gamma \qyields (\Theta, a) : \Delta, A} \and
%\inferrule*[left=sub-lin-ext]{\Gamma \qyields \Theta : \Delta \and \Gamma \qyields a : A[\Theta]}{\Gamma \qyields (\Theta, a) : \Delta, A} \and
%\inferrule*[left=sub-lin-comp]{\Gamma \qyields \Theta : \Delta \and \Delta \qyields \kappa : \Lambda}{\Gamma \qyields \Theta ; \kappa : \Lambda} \\
%%%
...
\begin{enumerate}
\item[\textsc{ctx-lin-ext}] 
\item[\textsc{ctx-lin-var}] 
\end{enumerate}

For $\otimes$-types, the rules are immediate from the framework $\mathsf{F}$-type rules; no unpacking or rewriting is necessary.
\begin{enumerate}
\item[\textsc{$\otimes$-form}] 
\begin{align*}
\upstairs{A \otimes B} :\equiv \F{w. (\fst w) \otimes_\alpha (\snd w)}{\upstairs{A}, \upstairs{B}}
\end{align*}
\item[\textsc{$\otimes$-intro}] 
\begin{align*}
\upstairs{\otimespair{A,B}} :\equiv \FIs{w. (\fst w) \otimes_\alpha (\snd w)}{\upstairs{a}, \upstairs{b}}
\end{align*}
\item[\textsc{$\otimes$-elim}] 
\begin{align*}
\upstairs{\otimessplit{c}} :\equiv \FEs{w. (\fst w) \otimes_\alpha (\snd w)}{w}{x, y}{\upstairs{c}}
\end{align*}
\end{enumerate}

\begin{enumerate}
\item[\textsc{$\Sigma!$-form}] 
The formation is identical to ordinary $\Sigma$-formation:
\begin{align*}
\upstairs{\Sigma!_A B} :\equiv \F{w. \Sigma!(\fst w, \snd w)}{\upstairs{A}, \upstairs{B}[\StI{\chi}{\alpha, x}/\beta]}
\end{align*}

\item[\textsc{$\Sigma!$-intro}] 
Here the type $\upstairs{\Sigma!_A B [\proj{\Gamma, A}]}$ is equal to:
\begin{align*}
\upstairs{\Sigma!_A B [\proj{\Gamma, A}]}
&\equiv \upstairs{\Sigma!_A B}[\upstairs{\proj{\Gamma, A}}/\alpha] \\
&\equiv \upstairs{\Sigma!_A B}[\StE{\chi}{\beta}{\alpha,x}{\rewrite{\pi^\alpha_x}{\alpha}}/\alpha] \\
&\equiv \StE{\chi}{\beta}{\alpha,x}{\upstairs{\Sigma!_A B}[\rewrite{\pi^\alpha_x}{\alpha}/\alpha]} \\
&\equiv \StE{\chi}{\beta}{\alpha,x}{\St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{\Sigma!_A B}}}
\end{align*}
...
\inferrule*[Left=rewrite]{
\inferrule*[Left=F-intro]{
\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\Sigma!(x,y)} \FIs{w. \Sigma!(\fst w, \snd w)}{x,y} : \upstairs{\Sigma!_A B}
}{
\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\TrPlus{\ApEl{p}{\pi^\alpha_x}}{\Sigma!(x,y)}} \StI{\ApEl{p}{\pi^\alpha_x}}{\FIs{w. \Sigma!(\fst w, \snd w)}{x,y}} : \St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{\Sigma!_A B}}}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_y \rewrite{\linsnd{x,y}}{\StI{\ApEl{p}{\pi^\alpha_x}}{\FIs{w. \Sigma!(\fst w, \snd w)}{x,y}}} : \St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{\Sigma!_A B}}}}
{\beta : \upstairs{\Gamma, A}, y : \upstairs{B} \yields_y \StE{\chi}{\beta}{\alpha,x}{\rewrite{\linsnd{x,y}}{\StI{\ApEl{p}{\pi^\alpha_x}}{\FIs{w. \Sigma!(\fst w, \snd w)}{x,y}}}} : \upstairs{\Sigma!_A B [\proj{\Gamma, A}]}}
\end{mathpar}

\item[\textsc{$\Sigma!$-elim}]
The translation of the provided term is:
\begin{align*}
\beta : \upstairs{\Gamma, A}, \xi : \upstairs{\Xi[\proj{\Gamma, A}]}, y : \upstairs{B} \yields_{\xi \otimes y} \upstairs{c} : \StE{\chi}{\beta}{\alpha, x}{\St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{C}}}
\end{align*}
So use:
\begin{mathpar}
\inferrule*[Left=F-elim]{
...
\inferrule*[Left=cut]{
\beta : \upstairs{\Gamma, A}, \xi : \upstairs{\Xi[\proj{\Gamma, A}]}, y : \upstairs{B} \yields_{\xi \otimes y} \upstairs{c} : \StE{\chi}{\beta}{\alpha, x}{\St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{C}}}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, \xi : \St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{\Xi}}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\xi \otimes y} \upstairs{c}[\StI{\chi}{\alpha, x}/\beta] : \St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{C}}}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, \xi : \upstairs{\Xi}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\TrPlus{\ApEl{p}{\pi^\alpha_x}}{\xi} \otimes y} \upstairs{c}[\StI{\chi}{\alpha, x}/\beta, \StI{\ApEl{p}{\pi^\alpha_x}}{\xi}/\xi] : \St{\ApEl{p}{\pi^\alpha_x}}{\upstairs{C}}}
\\\\
\alpha : \upstairs{\Gamma}, x : \upstairs{A}, z : \upstairs{C} \yields_{\Sigma!(x, \TrPlus{\ApEl{p}{\pi^\alpha_x}}{z})} \rewrite{\linwk{x,z}}{z} : \upstairs{C}
}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, \xi : \upstairs{\Xi}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\Sigma!(x,\TrPlus{\ApEl{p}{\pi^\alpha_x}}{\xi} \otimes y)} \\\\ \StE{\ApEl{p}{\pi^\alpha_x}}{\upstairs{c}[\StI{\chi}{\alpha, x}/\beta, \StI{\ApEl{p}{\pi^\alpha_x}}{\xi}/\xi]}{z}{\rewrite{\linwk{x,z}}{z}} : \upstairs{C} }}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, \xi : \upstairs{\Xi}, y : \upstairs{B}[\StI{\chi}{\alpha, x}/\beta] \yields_{\xi \otimes \Sigma!(x, y)} \\\\ \rewrite{\frob{\xi,x,y}}{\StE{\ApEl{p}{\pi^\alpha_x}}{\upstairs{c}[\StI{\chi}{\alpha, x}/\beta, \StI{\ApEl{p}{\pi^\alpha_x}}{\xi}/\xi]}{z}{\rewrite{\linwk{x,z}}{z}}} : \upstairs{C}}}
{\alpha : \upstairs{\Gamma}, \xi : \upstairs{\Xi}, w : \upstairs{\Sigma!_A B} \yields_{\xi \otimes w} \\\\ \FE{w}{x, y}{\rewrite{\frob{\xi,x,y}}{\StE{\ApEl{p}{\pi^\alpha_x}}{\upstairs{c}[\StI{\chi}{\alpha, x}/\beta, \StI{\ApEl{p}{\pi^\alpha_x}}{\xi}/\xi]}{z}{\rewrite{\linwk{x,z}}{z}}}} : \upstairs{C}}
\end{mathpar}
\end{enumerate}
