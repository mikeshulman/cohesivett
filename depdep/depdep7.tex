...
\mvrnote{There was a slight change to the definition of pair that needs to be fixed here} This one should be `easy'!
\begin{align*}
...
\mvrnote{There was a slight change to the definition of pair that needs to be fixed here} Let's try it:
\begin{align*}
