...
Finally, we have the 2-cells for $1/\Sigma$-modes:
\begin{mathpar}
...
\begin{definition}
A \emph{left adjoint} to a mode term $\gamma, y : q \yields u : p$ mode term is specified by constants:
\begin{align*}
...
\begin{definition}
For a mode $x : p$, a \emph{terminal object} of $p$ is specified by
\begin{mathpar}
...
\begin{definition}[Comprehension Object]\label{def:comprehension-object}
  ...
  constants:
  \begin{mathpar}
    p \type \and \alpha : p \yields \El{p}{\alpha} \type \and \alpha : p \yields 1_\alpha : \El{p}{\alpha}
    \\ 
...
(\eta_\alpha ; \pi^\alpha_{1_\alpha}, \ApOne{\eta_\alpha} ; \ApPlus{\ApEl{p}{\eta_\alpha}}{\var{1_\alpha}}) &\equiv \id_{(\alpha, 1_\alpha)}
\end{align}
...
\mvrnote{Conjecture:}
\begin{definition}
A comprehension object \emph{has unit} if $\eta^\chi$ is an isomorphism, i.e.:
\begin{align}
...
\begin{align*}
\upstairs{\qvar{\Gamma, A}} :\equiv \StE{\chi}{\beta}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}}
\end{align*}
because
\[
\inferrule*{
  \inferrule*{ {w : {\telety{\alpha}{\upstairs{\Gamma}}{\upstairs{A}}} \vdash_{{\snd{w}}} {{{\snd w}}} : {{\upstairs{A}[\fst w/\alpha]}}}    }
      {\inferrule*{ {w : {\telety{\alpha}{\upstairs{\Gamma}}{\upstairs{A}}} \vdash_{\TrPlus{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd{w}}} {{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}} : {\St{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\upstairs{A}[\fst w/\alpha]}}} }
                       {w : {\telety{\alpha}{\upstairs{\Gamma}}{\upstairs{A}}} \vdash_{1_{\fst w.\snd w \equiv \TrPlus{\chi}{w}}} {\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}} : {\St{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\upstairs{A}[\fst w/\alpha]}}}}
           }
           {
             \beta : \St{\chi}{\telety{\alpha}{\upstairs{\Gamma}}{\upstairs{A}}} \yields_{1_\beta} \StE{\chi}{\beta}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}} : \StE{\chi}{\beta}{w}{\St{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\upstairs{A}[\fst w/\alpha]}}
           }
\]
\end{enumerate}
...
&\equiv (\StE{\chi}{\beta}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}})[\rewrite{\eta^\chi_{\alpha}}{\StI{\chi}{(\upstairs{\Theta}, \upstairs{a})}}/\beta] \\
&\equiv \StE{\chi}{\rewrite{\eta^\chi_{\alpha}}{\StI{\chi}{(\upstairs{\Theta}, \upstairs{a})}}}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}} \\
&\equiv \rewrite{1_{\langle \eta^\chi_\alpha \rangle}}{\StI{\ApEl{p}{\eta^\chi_\alpha}}{\StE{\chi}{\StI{\chi}{(\upstairs{\Theta}, \upstairs{a})}}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}}}} \\
&\equiv \rewrite{1_{\langle \eta^\chi_\alpha \rangle}}{\StI{\ApEl{p}{\eta^\chi_\alpha}}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}[(\upstairs{\Theta}, \upstairs{a})/w]}} \\
&\equiv \rewrite{1_{\langle \eta^\chi_\alpha \rangle}}{\StI{\ApEl{p}{\eta^\chi_\alpha}}{\rewrite{\qvar{1_\alpha}}{\StI{\ApEl{p}{\pi^{\alpha}_{1_\alpha}}}{\upstairs{a}}}}} \\
...
&\equiv \rewrite{\eta^\chi_{\beta}}{\StI{\chi}{(\StE{\chi}{\beta}{w}{\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}}, \StE{\chi}{\beta}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}})}} \\
&\equiv \StE{\chi}{\beta}{w}{\rewrite{\eta^\chi_{\TrPlus{\chi}{w}}}{\StI{\chi}{(\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}, \rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}})}}} \\
...
\upstairs{\qvar{\Gamma, A}}[\into{\Gamma, A}/\beta] &\equiv \rewrite{\qvar{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}} \\
...
&\equiv  \StE{\chi}{\beta}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}}[\StI{\chi}{(\alpha, x)}/\beta]  \\
&\equiv \StE{\chi}{\StI{\chi}{(\alpha, x)}}{w}{\rewrite{\qvar{\snd w}}{\StI{\ApEl{p}{\pi^{\fst w}_{\snd w}}}{\snd w}}} \\
&\equiv \rewrite{\qvar{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}}
\end{align*}
For the last:
\begin{align*}
...
\begin{align*}
&(\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y] \\
&\equiv (\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{\upstairs{\qvar{\Gamma, A, B}}})
\end{align*}
which has type:
\begin{align*}
\delta :\upstairs{\Gamma, A, B} \yields_{\delta, 1_\delta, 1_{\delta.1_\delta}} (\alpha : \upstairs{\Gamma}, x : \upstairs{A}, \upstairs{B}[\into{\Gamma, A}/\beta]) \TYPE
\end{align*}
and 
\begin{align*}
...
\begin{align*}
&(\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y][\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y]/\delta] \\
&\equiv (\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y][\into{\Gamma, A, B}/\delta][\into{\Gamma, A}/\beta, y/y] \\
&\equiv (\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\upstairs{\proj{\Gamma, A, B}}[\into{\Gamma, A, B}/\delta]/\beta, \upstairs{\qvar{\Gamma, A, B}}[\into{\Gamma, A, B}/\delta]/y][\into{\Gamma, A}/\beta, y/y] \\
&\equiv (\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\rewrite{\pi^\beta_y}{\beta}/\beta, \rewrite{\qvar{y}}{\StI{\ApEl{p}{\pi^{\beta}_y}}{y}}/y][\into{\Gamma, A}/\beta, y/y] \\
&\equiv (\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta, \rewrite{\qvar{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}/y] \\
&\equiv (\upstairs{\proj{\Gamma, A}}[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta], \upstairs{\qvar{\Gamma, A}}[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta], \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y}[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta, \rewrite{\qvar{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}/y])\\
&\equiv (\rewrite{\pi^{\alpha.x}_y}{\upstairs{\proj{\Gamma, A}}[\into{\Gamma, A}/\beta]}, \rewrite{\ap{1_\beta}{\pi^{\alpha.x}_y/\beta}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{\upstairs{\qvar{\Gamma, A}}[\into{\Gamma, A}/\beta]}}, \StI{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\rewrite{\qvar{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}})\\
&\equiv (\rewrite{\pi^{\alpha.x}_y}{\rewrite{\pi^{\alpha}_x}{\alpha}}, \rewrite{\ap{1_\beta}{\pi^{\alpha.x}_y/\beta}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{\rewrite{\qvar{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}}}}, \StI{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\rewrite{\qvar{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}})\\
&\equiv \rewrite{\pi^{\alpha.x}_y}{\rewrite{\pi^{\alpha}_x}{\alpha}}, \rewrite{\ap{1_\beta}{\pi^{\alpha.x}_y/\beta}}{\rewrite{\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}}}}, \rewrite{\ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}}}{\StI{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}})\\
&\equiv (\rewrite{\pi^{\alpha.x}_y;\pi^{\alpha}_x}{\alpha}, \rewrite{\ap{1_\beta}{\pi^{\alpha.x}_y/\beta};\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^{\alpha}_x}}{x}}, \rewrite{\ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}}}{\StI{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}};\pi^{\alpha.x}_y}}{y}})\\
&\equiv (\rewrite{(\pi^{\alpha.x}_y;\pi^{\alpha}_x,\ap{1_\beta}{\pi^{\alpha.x}_y/\beta};\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}})}{(\alpha, x)}), \rewrite{\ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}}}{\StI{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}};\pi^{\alpha.x}_y}}{y}})\\
&\equiv (\rewrite{(\pi^{\alpha.x}_y;\pi^{\alpha}_x,\ap{1_\beta}{\pi^{\alpha.x}_y/\beta};\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}}, \ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}})}{(\alpha, x, y)})\\
\end{align*}
...
\begin{theorem}
The rules for strong $\Sigma$-types can be interpreted over any mode theory containing a comprehension object that supports strong $\Sigma$-types (Definition \ref{def:supports-strong-sigmas}), \mvrnote{and such that the $\mathsf{F}$-type for $\Sigma_1(\alpha,x,y)$ exists whenever needed}
\end{theorem}
...
\begin{align*}
\fibpair{\alpha,x,y} :\equiv \contract{\alpha.x.y};\ap{\Sigma_1(\alpha,x,y)}{(\pi^{\alpha.x}_y;\pi^{\alpha}_x,\ap{1_\beta}{\pi^{\alpha.x}_y/\beta};\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}}, \ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}})/(\alpha,x,y)}
\end{align*}
\end{definition}
...
\begin{align*}
&[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y}/y][\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y] \\
&\equiv [\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]
\end{align*}
which has type:
\begin{align*}
...
So all together:
\begin{align*}
\upstairs{\qpair{A,B}} :&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\alpha,\fst w, \snd w)}{(x, y)}[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y}/y][\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y]} \\
&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})}[\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y]} \\
&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}})}}
\end{align*}
%on the left:
%\begin{align*}
...
&\equiv \rewrite{\contract{\delta}}{\FI{(x, y)}[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y}/y][\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y]}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta] \\
&\equiv \rewrite{\contract{\alpha.x.y}}{\FI{(x, y)}[(\rewrite{(\pi^{\alpha.x}_y;\pi^{\alpha}_x,\ap{1_\beta}{\pi^{\alpha.x}_y/\beta};\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}}, \ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}})}{(\alpha, x, y)})/(\alpha,x,y)]} \\
&\equiv \rewrite{\contract{\alpha.x.y}}{\rewrite{\ap{\Sigma_1(\alpha,x,y)}{(\pi^{\alpha.x}_y;\pi^{\alpha}_x,\ap{1_\beta}{\pi^{\alpha.x}_y/\beta};\ApPlus{\ApEl{p}{\pi^{\alpha.x}_y}}{\qvar{x}}, \ApPlus{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\qvar{y}})/(\alpha,x,y)}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y;\pi^{\alpha}_x}}{\FI{(x, y)}}}} \\
...
\inferrule*[Left=Cut]
{\delta : \upstairs{\Gamma, A, B} \yields_{1_\delta} \upstairs{c} : \upstairs{C[(\proj{\Gamma, A, B};\proj{\Gamma, A}), \qpair{A,B}]}}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\into{\Gamma,A}/\beta] \yields_{1_{\alpha.x.y}} \upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta] : \St{\ApEl{p}{\pair{\alpha,x,y}}}{\upstairs{C}[\StI{\chi}{(\alpha, \FI{(x, y)})}/\beta]}}
}
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\into{\Gamma,A}/\beta] \yields_{1_{\alpha.\Sigma_1(\alpha.x.y)}} \StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]} : \upstairs{C}[\StI{\chi}{(\alpha, \FI{(x, y)})}/\beta]}
}
...
{
\beta : \upstairs{\Gamma, \Sigma_A B} \yields_{1_\beta} \rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s]}} : \upstairs{C}
}
\end{mathpar}
\mvrnote{Or because I can't figure out how to split lines in mathpar}
\begin{align*}
&\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\ &\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s]}}
\end{align*}
\end{enumerate}
...
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})\\&[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s]}}[\upstairs{(\proj{\Gamma, A, B};\proj{\Gamma, A}),\qpair{A,B}}/\beta] \\
%%%
...
%%%
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\rewrite{1_{\langle \id_\delta \bdot \contract{\delta} \rangle}}{\StI{\ApEl{p}{\id_\delta \bdot \contract{\delta}}}{\\&\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}[\fst w/x, \snd w/y][(\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}})/w]})}}} \\
%%%
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\rewrite{1_{\langle \id_\delta \bdot \contract{\delta} \rangle}}{\StI{\ApEl{p}{\id_\delta \bdot \contract{\delta}}}{\\&\StI{\ApEl{p}{\tsplit{\delta,1_\delta,1_{\delta.1_\delta}}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]}})}}} \\
\end{align*}
Simplifying that substitution by itself:
\begin{align*}
&\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y] \\
&\equiv \into{\Gamma, A, B}[\into{\Gamma, A}[\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x] /\beta, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y] \\
&\equiv \into{\Gamma, A, B}[\into{\Gamma, A}[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x][\upstairs{\proj{\Gamma, A, B}}/\beta]/\beta, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y] \\
&\equiv \into{\Gamma, A, B}[\rewrite{\pi^{\beta}_{1_{\beta}}}{\beta}[\upstairs{\proj{\Gamma, A, B}}/\beta]/\beta, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y] \\
&\equiv \into{\Gamma, A, B}[\rewrite{\pi^{\delta}_{1_{\delta}}}{\upstairs{\proj{\Gamma, A, B}}}/\beta, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]\\
&\equiv \rewrite{(\pi^{\delta}_{1_{\delta}} \bdot \id_{\TrPlus{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{1_\delta}})}{\into{\Gamma, A, B}[\upstairs{\proj{\Gamma, A, B}}/\beta, \upstairs{\qvar{\Gamma, A, B}}/y]}  \\
...
&\StI{\ApEl{p}{\tsplit{\delta,1_\delta,1_{\delta.1_\delta}}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]}}}}} \\
%%%
...
&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Delta, A}}[\upstairs{\proj{\Delta, A, B}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Delta, A, B}}})}}[\upstairs{\Theta \uparrow A \uparrow B}/\delta] \\
&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Delta, A}}[\upstairs{\proj{\Delta, A, B}}/\beta][\upstairs{\Theta \uparrow A \uparrow B}/\delta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Delta, A, B}}}[\upstairs{\Theta \uparrow A \uparrow B}/\delta])}} \\
&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Delta, A}}[\upstairs{\Theta \uparrow A}/\beta][\upstairs{\proj{\Gamma, A[\Theta], B[\Theta \uparrow A]}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A[\Theta], B[\Theta \uparrow A]}}})}} \\
&\equiv \rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Gamma, A[\Theta]}}[\upstairs{\proj{\Gamma, A[\Theta], B[\Theta \uparrow A]}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A[\Theta], B[\Theta \uparrow A]}}})}} \\
...
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s]}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta]/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta]/s]}} \\
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A[\Theta] B[\Theta \uparrow A]}}/\alpha]/\alpha, \upstairs{\qvar{\Delta, \Sigma_A[\Theta] B[\Theta \uparrow A]}/s}]}} \\
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\Theta}/\alpha]}[\fst w/x, \snd w/y]}[\upstairs{\proj{\Delta, \Sigma_A[\Theta] B[\Theta \uparrow A]}}/\alpha, \upstairs{\qvar{\Delta, \Sigma_A[\Theta] B[\Theta \uparrow A]}}/s]}} \\
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\upstairs{\Theta \uparrow A \uparrow B}/\delta][\into{\Delta, A[\Theta], B[\Theta \uparrow A]}[\into{\Delta, A[\Theta]}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Delta, \Sigma_A[\Theta] B[\Theta \uparrow A]}}/\alpha, \upstairs{\qvar{\Delta, \Sigma_A[\Theta] B[\Theta \uparrow A]}}/s]}} \\
\equiv{} & \upstairs{\qsplit{A[\Theta],B[\Theta \uparrow A]}(c[\Theta \uparrow A \uparrow B])}
\end{align*}
%Doing it in pieces, we have first:
%\begin{align*}
%&\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y][\upstairs{\Theta}/\alpha, x/x, y/y] \\
%\equiv{} &\into{\Delta, A, B}[\into{\Delta, A}[\upstairs{\Theta}/\alpha, x/x]/\beta, y/y] \\
%\equiv{} &\into{\Delta, A, B}[\upstairs{\Theta \uparrow A}[\into{\Gamma, A[\Theta]}/\beta]/\beta, y/y] \\
%\equiv{} &\into{\Delta, A, B}[\upstairs{\Theta \uparrow A}/\beta, y/y][\into{\Gamma, A[\Theta]}/\beta, y/y] \\
%\equiv{} &\upstairs{\Theta \uparrow A \uparrow B}[\into{\Gamma, A[\Theta], B[\Theta \uparrow A]}/\delta][\into{\Gamma, A[\Theta]}/\beta, y/y] \\
%\equiv{} &\upstairs{\Theta \uparrow A \uparrow B}[\into{\Gamma, A[\Theta], B[\Theta \uparrow A]}[\into{\Gamma, A[\Theta]}/\beta, y/y] /\delta]
%\end{align*}
%Do-over:
%\begin{align*}
%&\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s]}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s][\upstairs{\Theta \uparrow \Sigma_A B}/\beta]}} \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta]/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta]/s]}} \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/\beta]/\alpha, \upstairs{\qvar{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/s]}} \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\Theta}/\beta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/\alpha, \upstairs{\qvar{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/s]}} \\
%\end{align*}



%First, we can we push the substitution through the `let's
%\begin{align*}
%&\StE{\chi}{\upstairs{\Theta \uparrow \Sigma_A B}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%&\equiv \StE{\chi}{\rewrite{\eta^\chi_\beta}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}})}}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{\StE{\chi}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}})}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots[\fst w'/\alpha, \fst w/x, \snd w/y]}}} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots})[(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}})/w']} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}}}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha, \fst w/x, \snd w/y]})} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{(\StE{\chi}{\beta}{w'}{\rewrite{\qvar{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}})}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]})} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\rewrite{\qvar{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}}} \\
%&\equiv \StE{\chi}{\beta}{w'}{\StI{\El{p}{\eta^\chi_{\TrPlus{\chi}{w'}}}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\rewrite{\qvar{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}}} \\
%\end{align*}
%Together:
%\begin{align*}
%&\upstairs{\qsplit{A,B}(c)[\Theta \uparrow \Sigma_A B]} \\
%\equiv{} &\upstairs{\qsplit{A,B}(c)}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
%\equiv{} &(\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}})[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
%\equiv{} &\StE{\chi}{\upstairs{\Theta \uparrow \Sigma_A B}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} &\StE{\chi}{\rewrite{\eta^\chi_\beta}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}})}}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} &\StI{\ApEl{p}{\eta^\chi_\beta}}{\StE{\chi}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}})}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}}} \\
%\equiv{} &\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\upstairs{\qvar{\Delta, \Sigma_A B[\Theta]}}}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} &\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{(\StE{\chi}{\beta}{w'}{\rewrite{\qvar{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}})}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} & ??\\
%\equiv{} &\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y]/\delta]}[\upstairs{\Theta}[\fst w'/\alpha]/\alpha,\fst w/x, \snd w/y]}} \\
%\equiv{} &\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y]/\delta][\upstairs{\Theta}/\alpha, x/x, y/y]}[\fst w'/\alpha,\fst w/x, \snd w/y]}} \\
%\equiv{} &\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c[\Theta \uparrow A \uparrow B]}[\into{\Gamma, A[\Theta], B[\Theta \uparrow A]}[\into{\Gamma, A[\Theta]}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} &\upstairs{\qsplit{A[\Theta],B[\Theta \uparrow A]}(c[\Theta \uparrow A \uparrow B])}
%\end{align*}
\end{enumerate}
...
The rules for $\Pi$ types are given in Figure~\ref{fig:qit-pi-rules}. Note that  substitution commuting with $\mathsf{app}$ is derivable: \mvrnote{TODO}
...
\begin{theorem}
The rules for $\Pi$-types can be interpreted over any mode theory containing a comprehension object, \mvrnote{and such that certain $\mathsf{U}$-types exist}
\end{theorem}
...
\begin{align*}
\delta : \upstairs{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]} &\yields_{\Pi_1(\delta, 1_\delta, 1_\delta)} \upstairs{\qvar{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}(\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}) \\&: \upstairs{B}[\into{\Gamma, A}/\beta][\upstairs{(\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]};\proj{\Gamma, A})}/\alpha, x/x][\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}/x]
\end{align*}
And that type is:
\begin{align*}
&\upstairs{B}[\into{\Gamma, A}/\beta][\upstairs{(\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]};\proj{\Gamma, A})}/\alpha, x/x][\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}/x] \\
&\equiv \upstairs{B}[\into{\Gamma, A}/\beta][\upstairs{(\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]};\proj{\Gamma, A})}/\alpha, \upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}/x] \\
&\equiv \upstairs{B}[\into{\Gamma, A}/\beta][\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x][\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta] \\
...
\begin{align*}
\upstairs{\qapp{A,B}} :\equiv \StI{\eta^\chi_\delta}{\upstairs{\qvar{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}(\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]})}
\end{align*}
...
\end{align*}
\mvrnote{Although if it were just an isomorphism, that would be fine too}

%The inverse of the above, we are given:
%\begin{align*}
...
\equiv{} &\StI{\eta^\chi_\delta}{\upstairs{\qvar{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}(\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]})}[\upstairs{\id_{\Gamma, A}, \qlam(M)[\proj{\Gamma, A}]}/\delta] \\
\equiv{} &\StI{\eta^\chi_\beta}{\upstairs{\qvar{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}[\upstairs{\id_{\Gamma, A}, \qlam(M)[\proj{\Gamma, A}]}/\delta](\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}[\upstairs{\id_{\Gamma, A}, \qlam(M)[\proj{\Gamma, A}]}/\delta])} \\
\equiv{} &\StI{\eta^\chi_\beta}{\upstairs{\qlam(M)[\proj{\Gamma, A}]}(\upstairs{\qvar{\Gamma, A}})} \\
\equiv{} &\StI{\eta^\chi_\beta}{(\UI{x}{(\upstairs{M}[\into{\Gamma, A}/\beta])}[\upstairs{\proj{\Gamma, A}}/\alpha])(\upstairs{\qvar{\Gamma, A}})} \\
\equiv{} &\StI{\eta^\chi_\beta}{\upstairs{M}[\into{\Gamma, A}/\beta][\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x]} \\
\equiv{} &\StI{\eta^\chi_\beta}{\upstairs{M}[\rewrite{\pi^\beta_{1_\beta}}{\beta}/\beta]} \\
\equiv{} &\upstairs{M}
\end{align*} 
\item[{$\qlam(\qapp{A,B}[\id_{\Gamma, A}, f[\proj{\Gamma, A}]]) \equiv f$}:] \begin{align*}
&\upstairs{\qlam(\qapp{A,B}[\id_{\Gamma, A}, f[\proj{\Gamma, A}]])} \\
\equiv{} &\UI{x}{(\upstairs{\qapp{A,B}[\id_{\Gamma, A}, f[\proj{\Gamma, A}]]}[\into{\Gamma, A}/\beta])} \\
\equiv{} &\UI{x}{(\upstairs{\qapp{A,B}}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta][\into{\Gamma, A}/\beta])} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_\delta}{\upstairs{\qvar{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}(\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]})}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta][\into{\Gamma, A}/\beta])} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_\beta}{\upstairs{\qvar{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta](\upstairs{\qvar{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta])}[\into{\Gamma, A}/\beta])} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_\beta}{\upstairs{f[\proj{\Gamma, A}]}(\upstairs{\qvar{\Gamma, A}})[\into{\Gamma, A}/\beta]} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\upstairs{f[\proj{\Gamma, A}]}[\into{\Gamma, A}/\beta](\upstairs{\qvar{\Gamma, A}}[\into{\Gamma, A}/\beta]})}} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\upstairs{f}[\rewrite{\pi^\alpha_x}{\alpha}/\alpha](\rewrite{\qvar{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}})}} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\upstairs{f}(x)[\rewrite{\pi^\alpha_x}{\alpha}/\alpha,\rewrite{\qvar{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}}/x]}} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\rewrite{1_{\langle \ApPlus{\chi}{\varepsilon^\chi_{(\alpha, x)}}\rangle}}{\StI{\ApEl{p}{\ApPlus{\chi}{\varepsilon^\chi_{(\alpha, x)}}}}{\upstairs{f}(x)}}}} \\
\equiv{} &\UI{x}{(\rewrite{\ApPlus{\ApEl{p}{\eta^\chi_{\alpha.x}}}{1_{\langle \ApPlus{\chi}{\varepsilon^\chi_{(\alpha, x)}}\rangle}}}{\upstairs{f}(x)}} \\
\equiv{} &\UI{x}{\upstairs{f}(x)} \\
\equiv{} &\upstairs{f}
\end{align*}
\mvrnote{Certainly $\ApPlus{\ApEl{p}{\eta^\chi_{\alpha.x}}}{1_{\langle \ApPlus{\chi}{\varepsilon^\chi_{(\alpha, x)}}\rangle}}$ is the identity because $1$ is terminal, but is there a `better' reason?}
