...
\equiv{} &\UI{x}{(\StI{\eta^\chi_\delta}{\upstairs{\var{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}(\upstairs{\var{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]})}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta][\into{\Gamma, A}/\beta])} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_\beta}{\upstairs{\var{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta](\upstairs{\var{\Gamma, A}[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}[\upstairs{(\id_{\Gamma, A}, f[\proj{\Gamma, A}])}/\delta])}[\into{\Gamma, A}/\beta])} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_\beta}{\upstairs{f[\proj{\Gamma, A}]}(\upstairs{\var{\Gamma, A}})[\into{\Gamma, A}/\beta]} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\upstairs{f[\proj{\Gamma, A}]}[\into{\Gamma, A}/\beta](\upstairs{\var{\Gamma, A}}[\into{\Gamma, A}/\beta]})}} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\upstairs{f}[\rewrite{\pi^\alpha_x}{\alpha}/\alpha](\rewrite{\var{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}})}} \\
\equiv{} &\UI{x}{(\StI{\eta^\chi_{\alpha.x}}{\upstairs{f}(x)[\rewrite{\pi^\alpha_x}{\alpha}/\alpha,\rewrite{\var{x}}{\StI{\ApEl{p}{\pi^{\alpha}_x}}{x}}/x]}} \\
