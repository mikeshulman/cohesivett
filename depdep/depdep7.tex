...
And the third by applying the previous to each $\pi$ and fusing $\bdot$.
\end{proof}

%\begin{proposition}
%If $p$ has unit, then $1_\alpha : \El{p}{\alpha}$ is terminal?
%\end{proposition}
%\begin{proof}
%\end{proof}
...
\begin{definition}\label{def:has-sigmas}
A comprehension object \emph{has $\Sigma$s} if it has unit and there is a specified mode term
\begin{align*}
...
\begin{lemma}
A comprehension object with $\Sigma$s satisfies the following equations:
\begin{align}
...
%&\equiv \contract{\alpha.1_\alpha.1_{\alpha.1_\alpha}};\ap{\Sigma_1(\alpha,x,y)}{(\pi^{\alpha.1_\alpha}_{1_{\alpha.1_\alpha}};\pi^{\alpha}_{1_\alpha},\ApOne{\pi^{\alpha.1_\alpha}_{1_{\alpha.1_\alpha}}};\ApPlus{\ApEl{p}{\pi^{\alpha.1_\alpha}_y}}{\var{1_\alpha}}, \ApOne{\pi^{\alpha.1_\alpha.{1_{\alpha.1_\alpha}}}_{1_{\alpha.1_\alpha.1_{\alpha.1_\alpha}}}};\ApPlus{\ApEl{p}{\pi^{\alpha.1_\alpha.{1_{\alpha.1_\alpha}}}_{1_{\alpha.1_\alpha.{1_{\alpha.1_\alpha}}}}}}{\var{1_{\alpha.1_\alpha}}})/(\alpha,x,y)}
...
\begin{align*}
\pinv{\alpha,x} : \TrPlus{\ApEl{p}{\pi^\alpha_x}}{1_\alpha} \vDash_{\El{p}{\alpha.x}} 1_{\alpha.x} 
\end{align*}
such that
\begin{align*}
\ApPlus{\ApEl{p}{\eta^\chi_\alpha}}{\pinv{\alpha,1_\alpha}} &\equiv  \ApOne{\eta^\chi_\alpha} \\
\pinv{\alpha,x};\ApPlus{\eta^\chi_{\alpha.x}}{\ap{\TrPlus{\pi^u_v}{1_u}}{(\pi^\alpha_x,\var{x})/(u,v)}} &\equiv \id_{\TrPlus{\ApEl{p}{\pi^\alpha_x}}{1_\alpha}}
\end{align*}
\mvrnote{Is that thing, $\ApPlus{\eta^\chi_{\alpha.x}}{\ap{\TrPlus{\pi^u_v}{1_u}}{(\pi^\alpha_x,\var{x})/(u,v)}}$ equal to $\ApOne{\pi^\alpha_x}$? I couldn't tell...}
\end{definition}

\begin{lemma}
If $1_\alpha : \El{p}{\alpha}$ is a fibred terminal object, then $p$ has $\Pi$s.
\end{lemma}
\begin{proof}
Take $\pinv{\alpha,x}$ to be the identity on $1_{\alpha.x}$ and then the equations hold trivially.
\end{proof}
...
Suppose $p$ has unit. \mvrnote{(I don't see how to avoid this)} There are terms:
\begin{align*}
...
\end{proof}
%\begin{align*}
%(\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{1_\delta}}{\delta}/\delta])
%\end{align*}
%has type:
%\begin{align*}
...
%because the type of 
%\begin{align*}
%\upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{1_\delta}}{\delta}] : \upstairs{B[\proj{\Gamma, A, B}]}
%\end{align*}
%is equal to
%\begin{align*}
%&\upstairs{B[\proj{\Gamma, A, B}]}[\rewrite{\pi^\delta_{1_\delta}}{\delta}] \\
%&\equiv \St{\ApEl{p}{\pi^\delta_{1_\delta}}}{\upstairs{B}[\upstairs{\proj{\Gamma, A, B}}/\beta]} \\
%&\equiv \St{\ApEl{p}{\pi^\beta_{1_\beta}}}{\upstairs{B}}[\upstairs{\proj{\Gamma, A, B}}/\beta] \\
%&\equiv \St{\ApEl{p}{\pi^\beta_{1_\beta}}}{\upstairs{B}}[\rewrite{\eta^\chi_\beta}{\into{\Gamma, A}[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x]/\beta]}[\upstairs{\proj{\Gamma, A, B}}/\beta] \\
%&\equiv \St{\ApEl{p}{\eta^\chi_\beta}}{\St{\ApEl{p}{\pi^\beta_{1_\beta}}}{\upstairs{B}}[\into{\Gamma, A}[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}/x]/\beta]}[\upstairs{\proj{\Gamma, A, B}}/\beta] \\
...
%\end{align*}
%
%Iterating $\into{}$ gives us: 
%\begin{align*}
%\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\into{\Gamma, A} /\beta] \yields_{\alpha.x.y} \into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] : \upstairs{\Gamma,A,B}
%\end{align*}
%We would like to know what happens when we compose these. Going one component at a time:
%\begin{align*}
%\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta][\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y]/\delta] 
%&\equiv \upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta][\into{\Gamma, A, B}/\delta][\into{\Gamma, A}/\beta, y/y] \\
%&\equiv \upstairs{\proj{\Gamma, A}}[\rewrite{\pi^\beta_y}{\beta}/\beta][\into{\Gamma, A}/\beta, y/y] \\
...
%&\equiv (\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\rewrite{\pi^\beta_y}{\beta}/\beta, \rewrite{\var{y}}{\StI{\ApEl{p}{\pi^{\beta}_y}}{y}}/y][\into{\Gamma, A}/\beta, y/y] \\
%&\equiv (\upstairs{\proj{\Gamma, A}}, \upstairs{\qvar{\Gamma, A}}, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y})[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta, \rewrite{\var{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}/y] \\
%&\equiv (\upstairs{\proj{\Gamma, A}}[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta], \upstairs{\qvar{\Gamma, A}}[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta], \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{y}[\rewrite{\pi^{\alpha.x}_y}{\into{\Gamma, A}}/\beta, \rewrite{\var{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}/y])\\
%&\equiv (\rewrite{\pi^{\alpha.x}_y}{\upstairs{\proj{\Gamma, A}}[\into{\Gamma, A}/\beta]}, \rewrite{\ap{1_\beta}{\pi^{\alpha.x}_y/\beta}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{\upstairs{\qvar{\Gamma, A}}[\into{\Gamma, A}/\beta]}}, \StI{\ApEl{p}{\pi^{\alpha.x.y}_{1_{\alpha.x.y}}}}{\rewrite{\var{y}}{\StI{\ApEl{p}{\pi^{\alpha.x}_y}}{y}}})\\
...
\begin{theorem}
The rules for the unit type can be interpreted over any mode theory containing a comprehension object $p$ that has unit \mvrnote{and such that the $\mathsf{F}$-type for $1_\alpha$ exists whenever needed}.
\end{theorem}
...
\end{align*}
\mvrnote{The mode $1$ vs the term $1_\alpha$ vs the object language $1_\Gamma$ could be confusing...}
...
\begin{align*}
\alpha : \upstairs{\Gamma} \yields_{1_\alpha} \upstairs{c} :\upstairs{C[\id_\Gamma, \star_\Gamma]} 
\end{align*}
...
\inferrule*[Left=F-elim]{
\inferrule*[Left=s-intro+rewrite]{
\alpha : \upstairs{\Gamma} \yields_{1_\alpha} \upstairs{c} :\St{\ApEl{p}{\eta^\chi_{\alpha}}}{\upstairs{C}[\StI{\chi}{(\alpha, \FI{()})}/\beta]} }
{\alpha : \upstairs{\Gamma} \yields_{1_{\alpha.1_\alpha}} \rewrite{\ApOne{\pi^\alpha_{1_\alpha}}}{\StI{\pi^\alpha_{1_\alpha}}{\upstairs{c}}} : \upstairs{C}[\StI{\chi}{(\alpha, \FI{()})}/\beta]}}
{\alpha : \upstairs{\Gamma}, s : \upstairs{1_\Gamma} \yields_{1_{\alpha.s}} \FEs{w.1_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{1_\alpha}}}{\StI{\pi^\alpha_{1_\alpha}}{\upstairs{c}}}} : \upstairs{C}[\StI{\chi}{(\alpha, s)}/\beta]}}
{\beta : \upstairs{\Gamma, 1_\Gamma} \yields_{1_{\beta.1_\beta}} \FEs{w.1_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{1_\alpha}}}{\StI{\pi^\alpha_{1_\alpha}}{\upstairs{c}}}}[\upstairs{\proj{\Gamma, 1_\Gamma}}/\alpha, \upstairs{\qvar{\Gamma, 1_\Gamma}}/s] : \upstairs{C}[\StI{\chi}{(\upstairs{\proj{\Gamma, 1_\Gamma}}, \upstairs{\qvar{\Gamma, 1_\Gamma}})}/\beta]}}
{\beta : \upstairs{\Gamma, 1_\Gamma} \yields_{1_{\beta}} \rewrite{\ApOne{\eta^\chi_\beta}}{\StI{\eta^\chi_\beta}{\FEs{w.1_\alpha}{s}{w}{\rewrite{\ApOne{\pi^\alpha_{1_\alpha}}}{\StI{\pi^\alpha_{1_\alpha}}{\upstairs{c}}}}[\upstairs{\proj{\Gamma, 1_\Gamma}}/\alpha, \upstairs{\qvar{\Gamma, 1_\Gamma}}/s]}} : \upstairs{C}}
\end{mathpar}
\end{enumerate}
...
Suppose the comprehension object has $\Sigma$s in the sense of Definition~\ref{def:has-sigmas}. In the framework, $\Sigma$-types are the $\mathsf{F}$-types for the mode term
\begin{align*}
...
\begin{align*}
[\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \upstairs{\qvar{\Gamma, A, B}}[\rewrite{\pi^\delta_{1_\delta}}{\delta}/\delta]/y]
\end{align*}
discussed earlier.
...
{\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{B}[\into{\Gamma,A}/\beta] \yields_{1_{\alpha.\Sigma_1(\alpha.x.y)}} \rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}} : \upstairs{C}[\StI{\chi}{(\alpha, \FI{(x, y)})}/\beta]}
}
{\alpha : \upstairs{\Gamma}, s : \upstairs{\Sigma_A B}\yields_{1_{\alpha.s}} \FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]}} : \upstairs{C}[\StI{\chi}{(\alpha, s)}/\beta]}
}
{
...
\begin{align*}
&\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\rewrite{\ApOne{\tsplit{\alpha,x,y}}}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\\ &\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]}})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\qvar{\Gamma, \Sigma_A B}}/s]}}
\end{align*}
\end{enumerate}
...
%%%
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\upstairs{\qpair{A,B}}}{w}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}[\fst w/x, \snd w/y]}})}} \\
%%%
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\rewrite{\contract{\delta}}{\FIs{w. \Sigma_1(\delta,\fst w, \snd w)}{(\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}})}}}{w}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}[\fst w/x, \snd w/y]}})}} \\
%%%
...
%%%
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\rewrite{1_{\langle \id_\delta \bdot \contract{\delta} \rangle}}{\StI{\ApEl{p}{\id_\delta \bdot \contract{\delta}}}{\\&\rewrite{\ApOne{\tsplit{\delta,x,y}}}{\StI{\ApEl{p}{\tsplit{\delta,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha]}[\fst w/x, \snd w/y][(\upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta], \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}})/w]}})}}} \\
%%%
\equiv{} &\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\rewrite{1_{\langle \id_\delta \bdot \contract{\delta} \rangle}}{\StI{\ApEl{p}{\id_\delta \bdot \contract{\delta}}}{\\&\rewrite{\ApOne{\tsplit{\delta,1_\delta,1_{\delta.1_\delta}}}}{\StI{\ApEl{p}{\tsplit{\delta,1_\delta,1_{\delta.1_\delta}}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]}}})}}} \\
%%%
\equiv{} &\rewrite{\ApOne{\eta^\chi_\beta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,1_\delta,1_{\delta.1_\delta}}}}{\StI{\ApEl{p}{\eta^\chi_\beta;(\id_\delta \bdot \contract{\delta});\tsplit{\delta,1_\delta,1_{\delta.1_\delta}}}}{\\&\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]}} \\
\equiv{} &\rewrite{\ApOne{\eta^\chi_\beta;\eta^\chi_{\beta.1_\beta}}}{\StI{\ApEl{p}{\eta^\chi_\beta;\eta^\chi_{\beta.1_\beta}}}{\\&\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\proj{\Gamma, A, B};\proj{\Gamma, A}}/\alpha, \upstairs{\qvar{\Gamma, A}}[\upstairs{\proj{\Gamma, A, B}}/\beta]/x, \StI{\ApEl{p}{\pi^{\delta}_{1_{\delta}}}}{\upstairs{\qvar{\Gamma, A, B}}}/y]}} \\
\end{align*}
...
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{(\StE{\chi}{\beta}{w'}{\rewrite{\var{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}})}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]})} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\rewrite{\var{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}}} \\
%&\equiv \StE{\chi}{\beta}{w'}{\StI{\El{p}{\eta^\chi_{\TrPlus{\chi}{w'}}}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\rewrite{\var{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}}} \\
%\end{align*}
%Together:
%\begin{align*}
%&\upstairs{\qsplit{A,B}(c)[\Theta \uparrow \Sigma_A B]} \\
...
%\equiv{} &\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{(\StE{\chi}{\beta}{w'}{\rewrite{\var{\snd w'}}{\StI{\ApEl{p}{\pi^{\fst w'}_{\snd w'}}}{\snd w'}}})}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha]/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} & ??\\
%\equiv{} &\StE{\chi}{\beta}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
