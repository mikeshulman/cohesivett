...
%and
%\begin{align*}
%&\upstairs{\proj{\Gamma, A}}[\upstairs{\Theta \uparrow A}/\beta] \\
%&\equiv (\StE{\chi}{\beta}{w}{\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}})[\upstairs{\Theta \uparrow A}/\beta] \\
%&\equiv \StE{\chi}{\upstairs{\Theta \uparrow A}}{w}{\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}} \\
%&\equiv \StE{\chi}{\rewrite{\eta^\chi_\beta}{\StI{\chi}{(\upstairs{\proj{\Gamma, A[\Theta]}; \Theta}, \upstairs{\var{\Gamma, A[\Theta]}})}}}{w}{\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}} \\
%&\equiv \rewrite{\eta^\chi_\beta}{\StE{\chi}{\StI{\chi}{(\upstairs{\proj{\Gamma, A[\Theta]}; \Theta}, \upstairs{\var{\Gamma, A[\Theta]}})}}{w}{\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}}} \\
%&\equiv \rewrite{\eta^\chi_\beta}{\rewrite{\pi^{\fst w}_{\snd w}}{\fst w}[(\upstairs{\proj{\Gamma, A[\Theta]}; \Theta}, \upstairs{\var{\Gamma, A[\Theta]}})/w]} \\
%&\equiv \rewrite{\eta^\chi_\beta}{\rewrite{\pi^{\beta}_{1_\beta}}{\upstairs{\proj{\Gamma, A[\Theta]}; \Theta}}} \\
%&\equiv \upstairs{\proj{\Gamma, A[\Theta]}; \Theta}\\
%&\equiv \upstairs{\Theta}[\upstairs{\proj{\Gamma, A[\Theta]}}/\beta]\\
%\end{align*}
...
\begin{definition}
  A \textbf{2-category with a universe} is a large 2-category $\M$ together with a fully faithful 2-functor $y:\M \hookrightarrow \Mhat$, where $\Mhat$ is a very large and locally large 2-category having finite limits, and a morphism $\Upshat : \Mtmhat \to \Mtyhat$ in $\Mhat$ that is both (1) an internal split fibration and (2) algebraically $\M$-representable, in the sense that for any map $y(C)\to \Mtyhat$, where $C\in \M$, has a specified pullback that also lies in the image of $y$.
\end{definition}
...
\begin{proof}
  ...
  Since split fibrations can be defined in terms of finite limits and diagrammatic 2-categorical structure (adjunctions), they are preserved by the restricted Yoneda embedding; thus $\Ups$ is also a split fibration.
