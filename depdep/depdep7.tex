...
&\equiv \upstairs{a}
\end{align*}
\mvrnote{The rewrite is the identity, because $1_\alpha$ is terminal, but also that exact composite is part of a triangle identity for $\chi$.}
...
\end{align*}
\mvrnote{Here we use that $1$ is terminal, so we have that $\pi^{\TrPlus{\chi}{w}}_{1_{\TrPlus{\chi}{w}}};\eta^\chi_{\TrPlus{\chi}{w}}$ is the identity, can we avoid this?}
\end{proof}
...
{
\beta : \upstairs{\Gamma, \Sigma_A B} \yields_{1_\beta} \rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\var{\Gamma, \Sigma_A B}}/s]}} : \upstairs{C}
}
\end{mathpar}
\mvrnote{Or because I can't figure out how to split lines in mathpar}
\begin{align*}
&\rewrite{1_{\langle \eta^\chi_\beta \rangle}}{\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\ &\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\var{\Gamma, \Sigma_A B}}/s]}}
\end{align*}
\end{enumerate}
...
%Do-over:
%\begin{align*}
%&\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\var{\Gamma, \Sigma_A B}}/s]}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta] \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}/\alpha, \upstairs{\var{\Gamma, \Sigma_A B}}/s][\upstairs{\Theta \uparrow \Sigma_A B}/\beta]}} \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Gamma, \Sigma_A B}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta]/\alpha, \upstairs{\var{\Gamma, \Sigma_A B}}[\upstairs{\Theta \uparrow \Sigma_A B}/\beta]/s]}} \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta]}[\fst w/x, \snd w/y]})[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/\beta]/\alpha, \upstairs{\var{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/s]}} \\
%\equiv{} &\rewrite{\ap{1_\beta}{\eta^\chi_\beta/\beta}}{\StI{\eta^\chi_\beta}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{s}{w}{\\&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Gamma, A, B}[\into{\Gamma, A}/\beta, y/y] /\delta][\upstairs{\Theta}/\beta]}[\fst w/x, \snd w/y]})[\upstairs{\proj{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/\alpha, \upstairs{\var{\Delta, \Sigma_{A[\Theta]} B[\Theta \uparrow A]}}/s]}} \\
%\end{align*}
...
%&\equiv \StE{\chi}{\rewrite{\eta^\chi_\beta}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\var{\Delta, \Sigma_A B[\Theta]}})}}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{\StE{\chi}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\var{\Delta, \Sigma_A B[\Theta]}})}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots[\fst w'/\alpha, \fst w/x, \snd w/y]}}} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{\dots})[(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\var{\Delta, \Sigma_A B[\Theta]}})/w']} \\
%&\equiv \StI{\El{p}{\eta^\chi_\beta}}{(\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\upstairs{\var{\Delta, \Sigma_A B[\Theta]}}}{w}{\dots[\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha, \fst w/x, \snd w/y]})} \\
...
%\equiv{} &\StE{\chi}{\rewrite{\eta^\chi_\beta}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\var{\Delta, \Sigma_A B[\Theta]}})}}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}} \\
%\equiv{} &\StI{\ApEl{p}{\eta^\chi_\beta}}{\StE{\chi}{\StI{\chi}{(\upstairs{\Theta}[\upstairs{\proj{\Delta, \Sigma_A B[\Theta]}}/\alpha], \upstairs{\var{\Delta, \Sigma_A B[\Theta]}})}}{w'}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\snd w'}{w}{ \\
%&\StI{\ApEl{p}{\tsplit{\alpha,x,y}}}{\upstairs{c}[\into{\Delta, A, B}[\into{\Delta, A}/\beta, y/y] /\delta]}[\fst w'/\alpha, \fst w/x, \snd w/y]}}} \\
%\equiv{} &\StI{\ApEl{p}{\eta^\chi_\beta}}{\FEs{w. \Sigma_1(\alpha,\fst w, \snd w)}{\upstairs{\var{\Delta, \Sigma_A B[\Theta]}}}{w}{ \\
...
\item[\textsc{$\Pi$-app}] First note that 
\begin{align*}
\upstairs{(\Pi_A B)[\proj{\Gamma, A}]}[\into{\Gamma, A}/\beta] 
&\equiv \U{c. \Pi_1(\alpha,x',c)}{x':\upstairs{A}}{\upstairs{B}[\into{\Gamma, A}/\beta][x'/x]}[\upstairs{\proj{\Gamma, A}}/\alpha][\into{\Gamma, A}/\beta] \\
&\equiv \U{c. \Pi_1(\alpha,x',c)}{x':\upstairs{A}}{\upstairs{B}[\into{\Gamma, A}/\beta][x'/x]}[\rewrite{\pi^\alpha_x}{\alpha}/\alpha] \\
&\equiv \St{\El{p}{\pi^\alpha_x}}{\U{c. \Pi_1(\alpha,x',c)}{\upstairs{A}}{\upstairs{B}[\into{\Gamma, A}/\beta][x'/x]}}
\end{align*}
So in context $\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{\Pi_A B[\proj{\Gamma, A}]}[\into{\Gamma, A}/\beta]$ we can do:
\begin{align*}
\alpha : \upstairs{\Gamma}, x : \upstairs{A}, y : \upstairs{\Pi_A B[\proj{\Gamma, A}]}[\into{\Gamma, A}/\beta] \yields_{\Pi_1(\alpha, x, \TrPlus{\eta^\chi_\alpha}{y})} (\StI{\eta^\chi_\alpha}{y})(x) : \upstairs{B}[\into{\Gamma, A}/\beta]
\end{align*}
And substitute with the appropriate unpacking and then transport.
\begin{align*}
&\delta : \upstairs{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}\yields_{1_\delta} \\ &\StI{\eta^\chi_\delta}{(\StI{\eta^\chi_\alpha}{y})(x)[\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]/\alpha, \upstairs{\var{\Gamma, A}}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]/x, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{\upstairs{\var{\Gamma, A, B}}}/y]} : \upstairs{B[\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}]}
\end{align*}
That type is actually right, as:
\begin{align*}
&\St{\eta^\chi_\delta}{\upstairs{B}[\into{\Gamma, A}/\beta][\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]/\alpha, \upstairs{\var{\Gamma, A}}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]/x, \StI{\ApEl{p}{\pi^{\beta}_{1_{\beta}}}}{\upstairs{\var{\Gamma, A, B}}}/y]} \\
&\equiv \St{\eta^\chi_\delta}{\upstairs{B}[\into{\Gamma, A}[\upstairs{\proj{\Gamma, A}}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]/\alpha, \upstairs{\var{\Gamma, A}}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]/x]/\beta]} \\
&\equiv \St{\eta^\chi_\delta}{\upstairs{B}[\into{\Gamma, A}[\upstairs{\proj{\Gamma, A}}/\alpha, \upstairs{\var{\Gamma, A}}/x]/\beta][\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]} \\
&\equiv \St{\eta^\chi_\delta}{\upstairs{B}[\rewrite{\pi^\beta_{1_\beta}}{\beta}/\beta][\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]} \\
&\equiv \upstairs{B}[\upstairs{\proj{\Gamma, A, \Pi_A B[\proj{\Gamma, A}]}}/\beta]
\end{align*}

%We are given 
%\begin{align*}
%\alpha : \upstairs{\Gamma} &\yields_{1_\alpha} \upstairs{f} : \U{c.\Pi_1(\alpha,x,c)}{x : \upstairs{A}}{\upstairs{B}[\into{\Gamma, A}/\beta]}
%\intertext{and we want} 
%\beta : \upstairs{\Gamma, A} &\yields_{1_\beta} \upstairs{\mathsf{app}(f)} : \upstairs{B}
%\end{align*}
%So we can do:
%\begin{mathpar}
%\inferrule*[Left=s-intro]{
%\inferrule*[Left=Cut]{
%\inferrule*[Left=U-elim]{\alpha : \upstairs{\Gamma} \yields_{1_\alpha} \upstairs{f} : \U{c.\Pi_1(\alpha,x,c)}{x : \upstairs{A}}{\upstairs{B}[\into{\Gamma, A}/\beta]}
%}{\alpha : \upstairs{\Gamma}, x : \upstairs{A} \yields_{\Pi_1(\alpha,x,1_\alpha)} \upstairs{f}(x) : \upstairs{B}[\into{\Gamma, A}/\beta]
%}}
%{\beta : \upstairs{\Gamma, A} \yields_{\Pi_1(\beta,1_\beta,1_\beta)} (\upstairs{f}(x))[\proj{\Gamma, A}/\alpha, \var{\Gamma, A}/x] : \upstairs{B}[\rewrite{\pi^\beta_{1_\beta}}{\beta}/\beta]}}
%{\beta : \upstairs{\Gamma, A} \yields_{1_\beta} \StI{\eta^\chi_{\beta}}{(\upstairs{f}(x))[\proj{\Gamma, A}/\alpha, \var{\Gamma, A}/x]} : \upstairs{B}}
%\end{mathpar}
%where in the subscript we have used:
%\begin{align*}
%\TrPlus{\eta^\chi_{\beta}}{\Pi_1(\alpha,x,1_\alpha)}
%&\equiv \TrPlus{\eta^\chi_{\beta}}{\TrPlus{\pi^\beta_{1_\beta}}{1_\beta}} \\
%&\equiv 1_\beta
%\end{align*}
...
\end{align*}
So we can substitute and use $U$-right.
\begin{align*}
...
And the equations:
\begin{enumerate}[style = multiline, labelwidth = 80pt]
\item[{$(\Pi_A B)[\Theta] \equiv \Pi_{A[\Theta]} B[\Theta \uparrow A] $}:] 
\item[{$\mathsf{app}(\mathsf{lam}(b)) \equiv b$}:] 
\item[{$\mathsf{lam}(\mathsf{app}(f)) \equiv f$}:] 
\item[{$\mathsf{lam}(b)[\Theta] \equiv \mathsf{lam}(b[\Theta \uparrow A])$}:] 
\end{enumerate}
