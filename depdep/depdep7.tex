...
\end{align*}
This type checks via Equation~\ref{eq:stype-subst}; in the second component we have
\begin{align*}
...
\begin{definition}
A 2-cell between mode substitutions $\gamma \yields t : \theta \tcell \theta' $ is given by a mode term 2-cell \[\gamma \yields_{\ctxtuple \delta} \ctxtuple t : \ctxtuple \theta \tcell \ctxtuple \theta' \].
\end{definition}
...
\begin{mathpar}
\inferrule{\gamma \yields t : \theta \tcell_\delta \theta' \and \gamma \yields s : \mu[\theta] \tcell \TrPlus{\ap{p}{t}}{\mu'[\theta']}}
