...
\begin{definition}
A comonad \emph{supports $\flat$-types} if there are constants
\begin{align*}
\alpha : p, x : \El{p}{\TrPlus{f}{\alpha}} &\yields \flat_1(x) : \El{p}{\TrPlus{f}{\alpha}} \\
\alpha : p &\yields \flatone{\alpha} : \One_{\TrPlus{f}{\TrPlus{f}{\alpha}}} \tcell_{\TrPlus{f}{\TrPlus{f}{\alpha}}} \TrPlus{\fcounit{\TrPlus{f}{\alpha}}}{\flat_1(\One_{\TrPlus{f}{\alpha}})}
\end{align*}
such that
\begin{align*}
...
\flatone{\alpha} &:\equiv \fone{\TrPlus{f}{\alpha}}
\end{align*}
where the latter typechecks with $\fcomult{x}$ cancelling with $\fcounit{\TrPlus{f}{\alpha}}$.
