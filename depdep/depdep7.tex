...
\inferrule*[left=$\flat$-intro]{~}{\Gamma, \lock, A, \lock \qyields \FlatI{A} : \Flattype{A}[(\proj{\Gamma, \lock, A};\counit{\Gamma}), \lock]} \and
\inferrule*[left=$\flat$-elim]{\Gamma, \lock, A, \lock \qyields c : C[(\proj{\Gamma, \lock, A};\counit{\Gamma}), \lock, \FlatI{A}]}{\Gamma, \lock, \Flattype{A} \qyields \FlatE{c} : C} \\
