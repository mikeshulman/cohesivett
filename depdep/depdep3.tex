...
\ap {\ap s {t'/\delta'}} {t/\delta} \equiv \ap s {(t,t'[t/\delta]) / (\delta,\delta')} \and
...
\item
  All judgements have an admissible substituton principle:
\begin{mathpar}
  \inferrule*[Left=Admissible]
              {\gamma,\delta \yields J \\
                \gamma \yields \theta : \delta
              }
              {\gamma \yields J[\theta]}
