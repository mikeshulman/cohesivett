...
\subsection{Algebraic Internal-Comprehension-Category Mode Theory (no
  strict equations on mode types)}
...
\item All mode theories must have the following rules for terms 
\begin{mathpar}
