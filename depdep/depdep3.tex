...
\begin{mathpar}
 ...
 \\
  ...
  \end{mathpar}
But now the only things we add are:
\begin{mathpar}
  \inferrule{\gamma \yields \alpha : p}
  ...
  \inferrule{\gamma \yields \alpha : p \and \gamma \yields \mu : \El{p}{\alpha}}
            ...
            \\
  \inferrule{\TermTwoT{\gamma}{s}{\alpha}{\beta}{p} \and \gamma \yields \mu : \beta \and \TermTwoT{\gamma}{m}{1}{\El{p}{s}^+(\mu)}{\El{p}{\alpha}}}
            {\TermTwoT{\gamma}{(s,m)}{\alpha}{\beta.\mu}{p}}
            \\
\inferrule*
...
(s,m);\pi &\equiv s \\
\end{align*}
(It doesn't seem that we can get $\id$ from $\pi$ and comprehension -- at least, I couldn't see how)
