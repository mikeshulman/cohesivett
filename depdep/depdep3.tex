...
\begin{mathpar}
  ...
  \inferrule{\gamma \yields \alpha : p}
   ...
   \inferrule{\gamma \yields \alpha : p}
            {\gamma \yields 1_\alpha : \El{p}{\alpha}} \and
  ...
  \\
            ...
            \and 
              \inferrule{\gamma \yields \alpha : p}
            {\TermTwoT{\gamma}{\id_\alpha}{\alpha}{\alpha}{p}}
            \and
  \inferrule{\gamma \yields \alpha : p \and \gamma \yields \mu : \El{p}{\alpha}}
            {\TermTwoT{\gamma}{\pi}{\alpha.\mu}{\alpha}{p}} \and
  \inferrule{\gamma \yields \alpha : p \and \gamma \yields \mu : \El{p}{\alpha}}
            {\TermTwoT{\gamma}{\mathsf{var}_\mu}{1_{\alpha.\mu}}{\El{p}{\pi}^+(\mu)}{\El{p}{\alpha.\mu}}} \and
\end{mathpar}
...
What equations do we need? Some of the following?
\begin{align*}
...
\alpha.\El{p}{s}^\circ(1_\beta) &\equiv \beta \\
\El{p}{\pi}^\circ(1_{\alpha.\mu}) &\equiv \mu \\
\El{p}{s}^+(\El{p}{\pi}^\circ(\mu)) &\equiv \El{p}{\pi}^\circ(\El{p}{(s, \El{p}{s}^+(\id_x))}^+(\mu)) \\
\eta_{\pi, \mu} &\equiv \El{p}{\pi}^\circ(\mathsf{var}_\mu)
\end{align*}
That last equation is wonky, I don't quite see how to line the RHS up with the type of the unit.
