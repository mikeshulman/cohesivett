...
\\
\inferrule*
    {\TermTwo{\gamma}{s}{\theta}{\theta'} \\
     \TermTwo{\gamma}{t}{\TrCirc{(\alpha[s])}{\mu}}{\mu'}}
    {\TermTwo{\gamma}{(s,t/x)}{(\theta, \mu/x)}{(\theta',\mu'/x)}}
...
\inferrule*
    {\TermTwo{\gamma, \delta}{s_1}{\mu}{\mu'} \\
      \TypeTwo{\gamma}{s_2}{\theta}{\theta'}}
    {\TermTwo{\gamma}{s_1[s_2]}{\TrCirc{(\alpha[s])}{\mu[\theta]}}{\mu'[\theta']}}
\end{mathpar}

These telescope 2-cell things could equivalently be expressed using $s^+$, by adjointness.
