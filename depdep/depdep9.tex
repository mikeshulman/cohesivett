...
\EEs{\modeof{(\Delta, A)}}{\upstairs{\Theta \uparrow A}}{\sigma}{M[\unpack{\Delta, A}{\sigma}]} &\equiv \EEs{(\modeof{\Delta}, x)}{(\upstairs{\Theta}, x)}{\sigma}{M[\unpack{\Delta}{\sigma}, x/x]}
\end{align*}
\end{lemma}
\begin{proof}
\mvrnote{first two}
...
&\equiv \EEs{\sdot}{\EIs{\sdot}{\upstairs{\Theta}, x}}{\sigma'}{\EEs{(\modeof{\Delta}, x)}{\sigma'}{\sigma}{M[\unpack{\Delta, A}{\sigma}]}} \\
...
&\equiv \EEs{\modeof{(\Gamma, 1_\Gamma)}}{\upstairs{\id_\Gamma, \star_\Gamma}}{\sigma}{\upstairs{C}[\unpack{\Gamma, 1_\Gamma}{\sigma}]} \\
&\equiv \EEs{\modeof{\Gamma, 1_\Gamma}}{\rewrite{\eta^\sdot_{\modeof{\Gamma}}}{\EIs{\sdot}{\upstairs{\id_\Gamma}, \upstairs{\star_\Gamma}}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, 1_\Gamma}{\sigma}]} \\
&\equiv \St{\ApEl{p}{\eta^\sdot_{\modeof{\Gamma}}}}{\EEs{\modeof{(\Gamma, 1_\Gamma)}}{\EIs{\sdot}{\upstairs{\id_\Gamma}, \upstairs{\star_\Gamma}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, 1_\Gamma}{\sigma}]}} \\
&\equiv \St{\ApEl{p}{\eta^\sdot_{\modeof{\Gamma}}}}{\EEs{\modeof{(\Gamma, 1_\Gamma)}}{\EIs{\sdot}{\EIs{\modeof{\Gamma}}{\pack{\Gamma}}, \upstairs{\star_\Gamma}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, 1_\Gamma}{\sigma}]}} \\
&\equiv \St{\ApEl{p}{\eta^\sdot_{\modeof{\Gamma}}}}{\EEs{\modeof{(\Gamma, 1_\Gamma)}}{\EIs{\modeof{(\Gamma, 1_\Gamma)}}{\pack{\Gamma}, \upstairs{\star_\Gamma}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, 1_\Gamma}{\sigma}]}} \\
&\equiv \St{\ApEl{p}{\eta^\sdot_{\modeof{\Gamma}}}}{\upstairs{C}[\unpack{\Gamma, 1_\Gamma}{\sigma}][\pack{\Gamma}/\sigma, \upstairs{\star_\Gamma}/x]} \\
...
&\equiv \EEs{\modeof{(\Gamma, \Sigma_A B)}}{\upstairs{(\proj{\Gamma, A, B};\proj{\Gamma, A}), \qpair{A,B}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, \Sigma_A B}{\sigma}]} \\
&\equiv \EEs{\modeof{(\Gamma, \Sigma_A B)}}{\rewrite{\pair{x,y}}{\EIs{\sdot}{\upstairs{\id_\Gamma},\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}{\sigma}{\upstairs{C}[\unpack{(\Gamma, \Sigma_A B)}{\sigma}]} \\
&\equiv \St{\ApEl{p}{\pair{x,y}}}{\EEs{\modeof{(\Gamma, \Sigma_A B)}}{\EIs{\sdot}{\upstairs{\id_\Gamma},\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, \Sigma_A B}{\sigma}]}} \\
&\equiv \St{\ApEl{p}{\pair{x,y}}}{\EEs{\modeof{\Gamma, \Sigma_A B}}{\EIs{\sdot}{\EIs{\modeof{\Gamma}}{\pack{\downstairs{\Gamma}}},\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}{\sigma}{\upstairs{C}[\unpack{\Gamma, \Sigma_A B}{\sigma}]}} \\
...
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\F{w. \Sigma_1(\modeof{\Delta},\fst w, \snd w)}{x : \upstairs{A}, \upstairs{B}}[\unpack{\Delta}{\sigma}]} \\
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\F{w. \Sigma_1(\modeof{\Delta}[\unpack{\Delta}{\sigma}],\fst w, \snd w)}{x : \upstairs{A}[\unpack{\Delta}{\sigma}], \upstairs{B}[\unpack{\Delta}{\sigma}, x / x] }} \\
&\equiv \F{w. \Sigma_1(\modeof{\Gamma},\fst w, \snd w)}{x : \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{A}[\unpack{\Delta}{\sigma}]}, \EEs{(\modeof{\Delta}, x)}{(\upstairs{\Theta},x)}{\sigma, x}{\upstairs{B}[\unpack{\Delta}{\sigma}, x/x]} } \\
&\equiv \F{w. \Sigma_1(\modeof{\Gamma},\fst w, \snd w)}{x : \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{A}[\unpack{\Delta}{\sigma}]}, \EEs{\modeof{(\Delta, A)}}{\EIs{\sdot}{\upstairs{\Theta},x}}{\sigma, x}{\upstairs{B}[\unpack{\Delta, A}{\sigma}]} } \\
&\equiv \F{w. \Sigma_1(\modeof{\Gamma},\fst w, \snd w)}{x : \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{A}[\unpack{\Delta}{\sigma}]}, \EEs{\modeof{(\Delta, A)}}{\upstairs{\Theta \uparrow A}}{\sigma, x}{\upstairs{B}[\unpack{\Delta, A}{\sigma}]} } \\
...
&\equiv \EEs{\modeof{(\Delta, A, B)}}{\upstairs{\Theta \uparrow A \uparrow B}}{\sigma}{\upstairs{\qpair{A, B}}[\unpack{\Delta, A, B}{\sigma}]} \\
&\equiv \EEs{\modeof{(\Delta, A, B)}}{\EIs{\sdot}{\EIs{\sdot}{\upstairs{\Theta}, x}, y}}{\sigma}{\upstairs{\qpair{A, B}}[\unpack{\Delta, A, B}{\sigma}]} \\
&\equiv \EEs{(\modeof{\Delta}, x, y)}{(\upstairs{\Theta},x,y)}{\sigma,x,y}{\upstairs{\qpair{A, B}}[\unpack{\Delta}{\sigma}, x/x, y/y]} \\
&\equiv \EEs{(\modeof{\Delta}, x, y)}{(\upstairs{\Theta},x,y)}{\sigma,x,y}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\modeof{\Delta}.x}_y;\pi^{\modeof{\Delta}}_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}[\unpack{\Delta}{\sigma}, x/x, y/y]} \\
&\equiv \EEs{(\modeof{\Delta}, x, y)}{(\upstairs{\Theta},x,y)}{\sigma,x,y}{\rewrite{\fibpair{x,y}}{\StI{\ApEl{p}{\pi^{\modeof{\Delta}[\unpack{\Delta}{\sigma}].x}_y;\pi^{\modeof{\Delta}[\unpack{\Delta}{\sigma}]}_x}}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}} \\
...
&\equiv \EEs{\modeof{(\Delta, \Sigma_A B)}}{\upstairs{\Theta \uparrow \Sigma_A B}}{\sigma}{(\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\upstairs{c}}}})[\unpack{\Delta, \Sigma_A B}{\sigma}]} \\
&\equiv \EEs{(\modeof{\Delta}, z)}{(\upstairs{\Theta}, z)}{\sigma, z}{(\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\upstairs{c}}}})[\unpack{\Delta}{\sigma}, z/z]} \\
&\equiv \EEs{(\modeof{\Delta}, z)}{(\upstairs{\Theta}, z)}{\sigma, z}{\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\upstairs{c}[\unpack{\Delta}{\sigma}, x/x, y/y]}}}} \\
&\equiv \EEs{(\modeof{\Delta}, z)}{(\upstairs{\Theta}, z)}{\sigma, z}{\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\\&\qquad \EEs{(\modeof{\Delta}, x, y)}{(\EIs{\modeof{\Delta}}{\sigma},x, y)}{\sigma,x,y}{\upstairs{c}[\unpack{\Delta}{\sigma}, x/x, y/y]}}}}} \\
&\equiv \FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\EEs{(\modeof{\Delta}, x, y)}{(\upstairs{\Theta}, x, y)}{\sigma,x,y}{\upstairs{c}[\unpack{\Delta}{\sigma}, x/x, y/y]}}}} \\
&\equiv \FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\EEs{\modeof{(\Delta, A, B)}}{\upstairs{\Theta \uparrow A \uparrow B}}{\sigma}{\upstairs{c}[\unpack{\Delta, A, B}{\sigma}]}}}} \\
...
&\equiv \EEs{\modeof{(\Gamma, \Sigma_A B)}}{\upstairs{(\proj{\Gamma, A, B};\proj{\Gamma, A}), \qpair{A,B}}}{\sigma}{\upstairs{\qsplit{A,B}(c)}[\unpack{\Gamma, \Sigma_A B}{\sigma}]} \\
&\equiv \EEs{\modeof{(\Gamma, \Sigma_A B)}}{\rewrite{\pair{x,y}}{\EIs{\sdot}{\upstairs{\id_\Gamma},\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}}{\sigma}{\upstairs{\qsplit{A,B}(c)}[\unpack{\Gamma, \Sigma_A B}{\sigma}]} \\
&\equiv \rewrite{\ApOne{\pair{x,y}}}{\StI{\ApEl{p}{\pair{x,y}}}{\EEs{\modeof{\Gamma, \Sigma_A B}}{\EIs{\sdot}{\upstairs{\id_\Gamma},\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}{\sigma}{\upstairs{\qsplit{A,B}(c)}[\unpack{\Gamma, \Sigma_A B}{\sigma}]}}} \\
&\equiv \rewrite{\ApOne{\pair{x,y}}}{\StI{\ApEl{p}{\pair{x,y}}}{\EEs{\modeof{\Gamma, \Sigma_A B}}{\EIs{\sdot}{\EIs{\modeof{\Gamma}}{\pack{\Gamma}},\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}{\sigma}{\upstairs{\qsplit{A,B}(c)}[\unpack{\Gamma, \Sigma_A B}{\sigma}]}}} \\
...
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\U{c. \Pi_1(\modeof{\Delta},x,c)}{x : \upstairs{A}}{\upstairs{B}}[\unpack{\Delta}{\sigma}]} \\
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\U{c. \Pi_1(\modeof{\Delta}[\unpack{\Delta}{\sigma}],x,c)}{x : \upstairs{A}[\unpack{\Delta}{\sigma}]}{\upstairs{B}[\unpack{\Delta}{\sigma}], x/x}} \\
&\equiv \U{c. \Pi_1(\modeof{\Gamma},x,c)}{x : \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{A}[\unpack{\Delta}{\sigma}]}}{\EEs{(\modeof{\Delta}, x)}{(\upstairs{\Theta}, x)}{\sigma, x}{\upstairs{B}[\unpack{\Delta}{\sigma}, x/x]}} \\
&\equiv \U{c. \Pi_1(\modeof{\Gamma},x,c)}{x : \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{A}[\unpack{\Delta}{\sigma}]}}{\EEs{\modeof{(\Delta,A)}}{\StI{\sdot}{\upstairs{\Theta}, x}}{\sigma}{\upstairs{B}[\unpack{\Delta, A}{\sigma}]}} \\
&\equiv \U{c. \Pi_1(\modeof{\Gamma},x,c)}{x : \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{A}[\unpack{\Delta}{\sigma}]}}{\EEs{\modeof{(\Delta,A)}}{\upstairs{\Theta \uparrow A}}{\sigma}{\upstairs{B}[\unpack{\Delta, A}{\sigma}]}} \\
...
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\upstairs{\qlam{b}}[\unpack{\Delta}{\sigma}]} \\
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\UI{x}{\rewrite{\pinv{x}}{\upstairs{b}}}[\unpack{\Delta}{\sigma}]} \\
&\equiv \EEs{\modeof{\Delta}}{\upstairs{\Theta}}{\sigma}{\UI{x}{\rewrite{\pinv{x}}{\upstairs{b}[\unpack{\Delta}{\sigma}, x/x]}}} \\
&\equiv \UI{x}{\rewrite{\pinv{x}}{\EEs{(\modeof{\Delta}, x)}{(\upstairs{\Theta}, x)}{\sigma, x}{\upstairs{b}[\unpack{\Delta}{\sigma}, x/x]}}} \\
&\equiv \UI{x}{\rewrite{\pinv{x}}{\EEs{\modeof{(\Delta, A)}}{\upstairs{\Theta \uparrow A}}{\sigma}{\upstairs{b}[\unpack{\Delta,A}{\sigma}]}}} \\
