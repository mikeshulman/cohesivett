...
\mvrnote{Are the following needed?}
\begin{lemma}
...
\nonumber \\
\qapp{A,B}[\id_{\Gamma, A}, \qlam(b)[\proj{\Gamma, A}]] &\equiv b \\
...
\end{mathpar}
\item[\textsc{$\Pi$-elim}] We are trying to form a term
\begin{align*}
\upstairs{\Gamma}, x : \upstairs{A}, f : \St{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{\upstairs{\Pi_A B}} &\yields_{\One_{\modeof{\Gamma}.x.f}} \upstairs{\qapp{A,B}} : \St{\ApEl{p}{\pi^{\modeof{\Gamma}.x}_f}}{\upstairs{B}}
\end{align*}
Use:
\begin{mathpar}
\inferrule*[Left=rewrite]{
...
\inferrule*[Left=s-elim]{
\inferrule*[Left=U-elim]{~}
{\upstairs{\Gamma}, x : \upstairs{A}, f' : \upstairs{\Pi_A B} \yields_{\TrPlus{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{f'}} \UE{f'}{x} : \upstairs{B}}}
{\upstairs{\Gamma}, x : \upstairs{A}, f : \St{\pi^{\modeof{\Gamma}}_x}{\upstairs{\Pi_A B}} \yields_{f} \StE{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{f}{f'}{\UE{f'}{x}} : \upstairs{B}}}
{\upstairs{\Gamma}, x : \upstairs{A}, f : \St{\pi^{\modeof{\Gamma}}_x}{\upstairs{\Pi_A B}} \yields_{\TrPlus{\ApEl{p}{\pi^{\modeof{\Gamma}.x}_f}}{f}} \StI{\ApEl{p}{\pi^{\modeof{\Gamma}.x}_f}}{\StE{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{f}{f'}{\UE{f'}{x}}} : \St{\ApEl{p}{\pi^{\modeof{\Gamma}.x}_f}}{\upstairs{B}}}}
{\upstairs{\Gamma}, x : \upstairs{A}, f : \St{\pi^{\modeof{\Gamma}}_x}{\upstairs{\Pi_A B}} \yields_{\One_{\modeof{\Gamma}.x.f}} \rewrite{\var{f}}{\StI{\ApEl{p}{\pi^{\modeof{\Gamma}.x}_f}}{\StE{\ApEl{p}{\pi^{\modeof{\Gamma}}_x}}{f}{f'}{\UE{f'}{x}}}} : \St{\ApEl{p}{\pi^{\modeof{\Gamma}.x}_f}}{\upstairs{B}}}
\end{mathpar}

\mvrnote{Or in the other style}, we are given
\begin{align*}
...
\item[{$\qapp{A,B}[\id_{\Gamma, A}, \qlam(b)[\proj{\Gamma, A}]] \equiv M$}:] 
\begin{align*}
&\upstairs{\qapp{A,B}[\id_{\Gamma, A}, \qlam(b)[\proj{\Gamma, A}]]} \\
&\equiv \StE{\tshape{\Gamma, A, (\Pi_A B)[\proj{\Gamma, A}]}}{\upstairs{\id_{\Gamma, A}, \qlam(b)[\proj{\Gamma, A}]}}{\sigma}{\upstairs{\qapp{A,B}}[\unpack{\Gamma, A, (\Pi_A B)[\proj{\Gamma, A}]}{\sigma}]} \\
&\equiv \StE{\tshape{\Gamma, A, (\Pi_A B)[\proj{\Gamma, A}]}}{\StI{\tdot}{\upstairs{\id_{\Gamma, A}}, \upstairs{\qlam(b)[\proj{\Gamma, A}]}}}{\sigma}{\upstairs{\qapp{A,B}}[\unpack{\Gamma, A, (\Pi_A B)[\proj{\Gamma, A}]}{\sigma}]} \\
&\equiv \upstairs{\qapp{A,B}}[\unpack{\Gamma, A}{\sigma}, f/f][\pack{\Gamma, A}, \upstairs{\qlam(b)[\proj{\Gamma, A}]}/f] \\
&\equiv \upstairs{\qapp{A,B}}[\upstairs{\qlam(b)[\proj{\Gamma, A}]}/f] \\
\end{align*}
%\begin{align*}
