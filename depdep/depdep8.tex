...
\textsc{s-elim} into terms and types commutes with telescope formation.
\end{lemma}
\begin{proof}
For types, this is:
\begin{align*}
...
%&\equiv \eta^\tdot_{\alpha.\One_\alpha} ; (\pi^\alpha_{\One_\alpha} \bdot \ApOne{\pi^\alpha_{\One_\alpha}}) ; (\id_\alpha \bdot \contract{\alpha});\tsplit{\alpha,\One_\alpha,\One_{\alpha.\One_\alpha}} \\
%&\equiv \eta^\tdot_{\alpha.\One_\alpha} ;  \eta^\tdot_{\alpha.\One_\alpha.\One_{\alpha.\One_\alpha}} ; (\pi^{\alpha.\One_\alpha}_{\One_{\alpha.\One_\alpha}} \bdot \ApOne{\pi^{\alpha.\One_\alpha}_{\One_{\alpha.\One_\alpha}}}) ; (\pi^\alpha_{\One_\alpha} \bdot \ApOne{\pi^\alpha_{\One_\alpha}}) ; (\id_\alpha \bdot \contract{\alpha});\tsplit{\alpha,\One_\alpha,\One_{\alpha.\One_\alpha}} \\
...
%&\equiv \eta^\tdot_{\alpha.\One_\alpha};\eta^\tdot_{\alpha.\One_\alpha.\One_{\alpha.\One_\alpha}};((\pi^{\alpha.\One_\alpha}_{\One_{\alpha.\One_\alpha}};\pi^\alpha_{\One_\alpha}) \bdot \fibpair{\alpha,\One_\alpha,\One_{\alpha.\One_\alpha}});\tsplit{\alpha,\One_\alpha,\One_{\alpha.\One_\alpha}} \\
%&\equiv \eta^\tdot_{\alpha.\One_\alpha};\pair{\alpha,\One_\alpha,\One_{\alpha.\One_\alpha}};\tsplit{\alpha,\One_\alpha,\One_{\alpha.\One_\alpha}} \\
%&\equiv \eta^\tdot_{\alpha.\One_\alpha}
%\end{align*}
\end{proof}
...
\StE{\tshape{\Delta, A}}{\upstairs{\Theta \uparrow A}}{\sigma}{M[\unpack{\Delta, A}{\sigma}]} &\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma}{M[\unpack{\Delta}{\sigma}, x/x]}
\end{align*}
\end{lemma}
\begin{proof}
\begin{align*}
...
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma'}{\StE{\tshape{\Delta, A}}{\StI{\tdot}{\StI{\tshape{\Delta}}{\sigma'}, x}}{\sigma}{M[\unpack{\Delta, A}{\sigma}]}} \\
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma'}{\StE{(\tshape{\Delta}, \id)}{\StI{(\tshape{\Delta}, \id)}{\sigma', x}}{\sigma}{M[\unpack{\Delta, A}{\sigma}]}} \\
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma'}{M[\unpack{\Delta, A}{\sigma', x}]} \\
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma'}{M[\unpack{\Delta}{\sigma'}, x/x]} \\
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma}{M[\unpack{\Delta}{\sigma}, x/x]}
\end{align*}
\end{proof}
...
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma}{\rewrite{\fibpair{x,y}}{\StI{(\pi^{\modeof{\Delta}.x}_y;\pi^{\modeof{\Delta}}_x)}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}[\unpack{\Delta}{\sigma}, x/x, y/y]} \\
&\equiv \StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma}{\rewrite{\fibpair{x,y}}{\StI{(\pi^{\TrPlus{\tshape{\Delta}}{\sigma}.x}_y;\pi^{\TrPlus{\tshape{\Delta}}{\sigma}}_x)}{\FIs{w. \Sigma_1(\fst w, \snd w)}{x,y}}}} \\
...
\begin{align*}
&\StE{\tshape{\Delta, \Sigma_A B}}{\upstairs{\Theta \uparrow \Sigma_A B}}{\sigma}{(\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\upstairs{c}}}})[\unpack{\Delta, \Sigma_A B}{\sigma}]} \\
&\StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma}{(\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\upstairs{c}}}})[\unpack{\Delta}{\sigma}, z/z]} \\
&\StE{\tshape{\Delta}}{\upstairs{\Theta}}{\sigma}{\FE{z}{x,y}{\rewrite{\ApOne{\tsplit{x,y}}}{\StI{\ApEl{p}{\tsplit{x,y}}}{\upstairs{c}[\unpack{\Delta}{\sigma}, x/x,y/y]}}}} \\
