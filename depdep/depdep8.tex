...
theory.  We write base type theory entities with lowercase Greek
letters, and refer to the types as \emph{mode types}, and terms as
\emph{mode terms}, and so on, to differentiate them from the types and
terms of the top type theory.
