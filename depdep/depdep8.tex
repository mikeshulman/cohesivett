...
that these types are judgementally equal.  
...
For the first equation (\ref{eq:stype-pair}), the right-hand
...
The next two
equations say that $\St{s}{A}$ is strictly functorial in $s$, with
corresponding equations for the introduction forms.
