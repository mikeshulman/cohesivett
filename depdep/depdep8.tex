...
and can form
\begin{align*}
\upstairs{\Gamma} \yields_{\El{p}{\modeof{\Gamma}}} \U{f_1}{1}{\upstairs{A}} \TYPE
\end{align*}
...
&\equiv \rewrite{\foneinv{\modeof{\Gamma}}}{\StE{\tshape{\Delta, \lock}}{\upstairs{\Theta, \lock}}{\sigma}{\UI{()}{\upstairs{a}[\unpack{\Delta, \lock}{\sigma}]}}} \\
